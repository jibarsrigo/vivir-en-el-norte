...
const RELATOS_BAIXO_MINO: Record<string, RelatoMun> = {
  "a-guarda": {
    ...
    abrir: [
      "A Guarda se siente más grande de lo que sugiere el mapa. Diez mil habitantes, y sin embargo hay lonja, mercado municipal, mercadillo semanal, restaurantes abiertos en enero y un paseo marítimo donde se sale a tomar café cualquier día del año. El casco baja en cuesta hasta el puerto: las casas de los marineros, de colores desgastados por la sal, dan a la dársena; detrás, siempre, el Monte Santa Trega, redondo, como si la villa hubiera crecido a su sombra y no pudiera olvidarlo —arriba hay castro, mirador y la boca del Miño abriéndose al Atlántico—. Portugal está tan cerca que, con el viento a favor, se oyen las campanas de Caminha, la villa portuguesa al otro lado de la desembocadura. No es una frase bonita: es distancia real. El Miño se estrecha, el otro país está a la vista, y el barco estacional —cuando opera— corta el estuario en minutos.",
      "Quien vive aquí es gente local, vecinos de toda la vida, y veraneantes que vuelven cada agosto. No es una urbanización de foráneos plantada sobre el paisaje. En invierno el puerto sigue trabajando: cajas, grúas, olor a pescado fresco, el ritmo de quien no cierra la temporada. Las terrazas del paseo no se vacían del todo, aunque el noroeste se nota en la cara. La villa está en la punta, donde el río entrega el agua al Atlántico y el viento entra de golpe. Para lo diario —farmacia, súper, mercado, colegio— no hace falta coche. Para el hospital Álvaro Cunqueiro, en Vigo, sí: unos cuarenta y cinco minutos. Ese dato no se arregla eligiendo otra calle.",
      "El tráfico es de pueblo casi todo el año. En julio y agosto lo cambia todo: la PO-552, carretera de costa de dos carriles, se atasca y avanza muy despacio entre faros y aparcamientos llenos. Quien busque silencio absoluto de invierno lo encontrará; quien busque el café de enero también. Las dos cosas conviven aquí, y eso es raro.",
      "La semana tiene rutinas claras: lonja, mercado municipal, mercadillo, el paseo marítimo al café cualquier día del año. Portugal no es escapada excepcional —Caminha, la villa portuguesa al otro lado de la desembocadura, a la vista; el barco estacional cuando opera—. Primavera y otoño son buenas épocas para conocerlo: en mayo el Monte Santa Trega se pone de un verde intenso; en octubre empieza la lluvia de verdad. Si solo conoces agosto, te llevas la imagen de folleto de la punta. Si has visto un noviembre, ya puedes decidir si de verdad quieres vivir aquí.",
    ...
    vivir: [
      ...
      "Llegar de fuera es menos dominante que en otras costas: conviven vecinos de toda la vida y veraneantes que vuelven en agosto. Se oye gallego en el mercado y en la lonja; el castellano basta para lo cotidiano. Entre semana manda el ritmo de puerto; en julio y agosto la PO-552 se atasca y avanza muy despacio. Si solo buscas veraneo, te llevas la imagen de folleto de la punta. Si buscas vecinos todo el año, también los encontrarás —con otra escala que Mallorca.",
      ...
      "Mantener el vínculo con Mallorca pasa por el avión. Vigo-Peinador está a unos cincuenta minutos; Porto, cerca de hora y media. Esta ficha no detalla un vuelo directo estable a Palma desde Peinador en invierno: conviene mirar el calendario real y contar también Santiago como alternativa cuando el enlace lo pida. El coste no es solo el billete, sino la logística de punta cuando el tiempo se pone feo.",
    ...
    fuera: [
      "Si solo hay tiempo para un baño cerca, ese baño es Area Grande. Queda a pie desde el casco: poco más de un kilómetro, cuatro minutos andando cuesta abajo hacia el océano. No es una playa infinita de foto mediterránea de folleto. Es una cala de arena fina, abrigada entre rocas, con paseo de madera y el Santa Trega detrás de fondo. El agua en agosto anda entre diecisiete y diecinueve grados: fresca, a veces con un golpe de frío, nunca tibia como Mallorca a veinticinco. Se entra, se nada un rato, se sale con la piel que se despierta del frío. Un martes de junio puedes tener casi toda la arena; un domingo de agosto el aparcamiento junto al paseo se queda corto y la gente busca sitio con paciencia. Es playa de diario —de vecinos, de toalla de siempre—, no de resort.",
      "Un poco más adentro, hacia Camposancos, el paisaje cambia por completo. O Muíño —tres kilómetros, seis minutos— ya no mira al Atlántico abierto: mira el estuario. Arena, agua plana, Portugal enfrente, merendero bajo los pinos, el embarcadero del barco a Caminha. Sin olas. Más templada. Es el sitio donde se lleva a quien no quiere pelear con el océano, o donde se viene a merendar con el río ancho delante y la sensación de frontera sin aduana. Más al norte, Praia da Lamiña es pequeña, entre rocas: un sitio de mirar, de oír el golpe del agua, más que de tender la toalla y quedarse la tarde.",
  ...
  oia: {
    ...
    tiempo: [
      ...
      "El viento y el oleaje marcan más que la cifra del termómetro. La PO-552 y el océano se oyen juntos; la niebla es baja. Un día de lluvia seria no se queda uno mirando el cristal: se baja a Baiona o a A Guarda, o se espera a que el chaparrón afloje para caminar la senda. Si solo conoces agosto, te llevas la imagen de folleto del horizonte. Si has visto un noviembre en aldea, ya puedes decidir si aceptas ese silencio.",
    ],
    vivir: [
      "El invierno en Oia se siente en la soledad de la casa tanto como en el termómetro. En Mallorca muchas viviendas casi no piensan en calefacción ni en humedad; aquí el Atlántico abierto y la Serra da Groba mantienen lluvia, viento y aire húmedo. Una casa aislada de piedra o un chalé con vistas puede retener moho si la ventilación y el aislamiento fallan. Visitar un noviembre en aldea —kilómetros sin cruzarse con nadie salvo el viento— enseña más que un agosto soleado junto al monasterio.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Quien descubra el sitio solo en agosto soleado se llevará solo la imagen de folleto del horizonte y descubrirá en noviembre el precio. Si el tiempo libre se quiere gastar en calle y café compacto, mejor A Guarda (villa de puerto) u O Rosal (valle con plaza); si se quiere mar a la puerta sin soledad, tampoco es este pueblo.",
      ],
      veredicto:
  ...
  "o-rosal": {
    ...
    vivir: [
      "El invierno en O Rosal se siente en las paredes más que en el termómetro. En Mallorca muchas casas casi no piensan en calefacción ni en humedad; en este valle interior la lluvia empapa el Folón, deja musgo y mantiene el aire húmedo entre parras desnudas. Conviene tocar las paredes en noviembre, preguntar por aislamiento y mirar rastros de moho. Visitar la casa un día de lluvia seria enseña más que el sol de abril del anuncio.",
      ...
      "Mantener el vínculo con Mallorca pasa por el avión desde fuera. La ficha sitúa Vigo alrededor de cuarenta minutos; conviene mirar vuelos desde Peinador o Santiago y el calendario real hacia Palma, no solo el de agosto. El coste incluye el trayecto desde el valle cuando el tiempo se pone feo.",
  ...
  tomino: {
    ...
    vivir: [
      ...
      "Mantener el vínculo con Mallorca pasa por el avión desde fuera. La ficha sitúa Vigo a unos treinta minutos; conviene mirar Peinador y Santiago y el calendario real de vuelos a Palma. En invierno la logística pesa más: niebla, trayecto y posibles escalas.",

...
/** Pie global discreto: acceso al archivo V1 (único enlace V1 en fichas de municipio). */
  ...
  return (
    <footer className="mt-16 border-t border-[var(--linea)]">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 text-sm text-[var(--tinta-suave)]">
        ...
        <Link
          href="/v1/"
          className="text-xs text-[var(--tinta-suave)] underline-offset-2 hover:underline"
        >
          V1
        </Link>
      </div>

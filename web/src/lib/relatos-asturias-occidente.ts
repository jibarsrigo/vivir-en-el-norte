...
export const RELATOS_ASTURIAS_OCCIDENTE: Record<string, RelatoMun> = {
  castropol: {
    ...
    abrir: [
      ...
      "La semana tiene anclas distintas a las de Navia o Luarca. Aquí el ancla es el paseo de ría, el mirar Ribadeo y bajar a Penarronda o a la orilla calmada del Eo cuando el Cantábrico abierto esté bravo. Primavera y otoño merecen su visita: el verde de la Reserva se pone imposible; en noviembre empieza el aprendizaje serio de la niebla alta. Quien solo conozca un sábado de sol de agosto firmará la postal; quien haya visto un martes vacío firmará —o no— la vida.",
    ...
    casa: [
      "El modelo de casa aquí no es la urbanización cerrada. Son viviendas en el pueblo blanco, hacia Figueras o en las parroquias: piedra, vistas a la ría, poca o ninguna obra nueva. La fibra es parcial. Pesan humedad de estuario, niebla alta, acceso y la distancia real a un súper completo.",
      "El precio medio ronda mil cincuenta euros el metro, el más bajo de Asturias Occidente. Tres habitaciones en tipologías modestas quedan en franja muy asequible; el estado de la reforma y las vistas claras al Eo mueven el precio más que el plano del anuncio. Conviene venir un día de niebla y comprobar aparcamiento en Penarronda cuando la costa se llena.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco encaja quien necesite hospital a diez o veinte minutos o aeropuerto cerca de una hora: Jarrio está a unos treinta; Asturias, a unos setenta y cinco. Quien firme solo un sábado de sol de agosto, sin probar niebla densa ni un noviembre vacío, se llevará una sorpresa. Si lo que se busca es cielo de Baleares —días despejados, verano caluroso, baño largo sin pensar en el oleaje—, esta orilla no lo da: el agua anda entre 18 y 20 °C y el Cantábrico abierto pide calma. Mejor mirar Navia (Jarrio a diez minutos) o Luarca (aeropuerto a unos cuarenta) si la logística manda más que la postal de pueblo blanco.",
      ],
      veredicto:
        "Veredicto: Castropol encaja como pueblo blanco de ría y frontera —vivienda con vistas claras al Eo, hacia Figueras o el promontorio, no como villa autosuficiente— sobre todo si la orilla y el precio pesan más que los servicios a pie. Apoyarse en Ribadeo para el día a día; comprobar fibra, humedad de ría y un noviembre de niebla antes de firmar. Se ganan silencio, Penarronda a diez minutos y el metro más bajo de la zona; se aceptan servicios 3/10, Jarrio a treinta minutos y Asturias a unos setenta y cinco. Quien priorice sanidad o villa completa, mirar Navia o Luarca.",
    },
    fotosAbrir: [
  ...
  "tapia-de-casariego": {
    ...
    abrir: [
      ...
      "La semana tiene anclas de puerto: lonja o pez fresco cuando toca, café junto a la dársena, paseo hacia el faro, bajar a la ola cuando el Cantábrico lo permita. La ruta costera hacia Figueras cierra el trayecto de frontera. Primavera y otoño merecen su visita: el verde de la costa occidental se pone intenso; en noviembre la niebla alta enseña el trato real. Quien solo conozca un sábado de sol en Anguileiro firmará la postal; quien haya visto un día de bruma pegada al faro firmará —o no— la vida.",
    ...
    vivir: [
      "El invierno en casa se nota por la niebla alta —de las más marcadas de la zona— y el salitre del puerto. En Mallorca muchas viviendas casi no piensan en humedad; aquí conviene mirar orientación menos abierta a la nortada, aislamiento y si la terraza al paseo sigue siendo usable entre noviembre y febrero. Visitar un día de bruma pegada al faro y otro de viento vale más que un sábado de sol en Anguileiro.",
      ...
      "La vivienda típica es piso o casa de villa marinera junto al puerto o al paseo: edificios bajos, terraza al Cantábrico, poca obra nueva y fibra. Junto a la orilla pesan salitre, niebla y ocupación de verano; hacia el interior del casco, el silencio vuelve antes. Reforma y orientación importan tanto como las vistas al faro.",
    ],
    historia: [
      "El puerto, el casco marinero y la isla del faro explican Tapia: villa de oficio del mar y de postal costera, cuidada y compacta. No es un decorado de temporada: la dársena y las calles estrechas cuentan trabajo y salitre. El surf contemporáneo —Anguileiro, Serantes, Represas— añade capa de orilla viva sin borrar el carácter de villa pequeña.",
      "La ruta costera hacia Figueras y la cercanía a la ría del Eo sitúan Tapia en la costa occidental asturiana de frontera. La historia útil es marinera y de paseo, no de gran casco indiano como Luarca ni de villa de servicios como Navia. Aquí el relato es faro, ola y casco que se reconoce en una sola tarde.",
    ],
    fuera: [
    ...
    casa: [
      "El casco y el entorno del puerto ofrecen pisos y viviendas de villa marinera: edificios bajos, terraza al paseo o al Cantábrico, poca obra nueva y fibra. Junto a la orilla pesan salitre, niebla alta y ocupación de verano. Conviene la orientación menos abierta a la nortada fuerte, y venir un día de viento, no solo un sábado de sol.",
      "El precio medio ronda mil trescientos cincuenta euros el metro, el más alto de la zona. Tres habitaciones en la franja asequible se sitúan alrededor de ciento cincuenta y ocho mil euros. La franja media puede ser vivienda reformada cerca del paseo o con mejores vistas al puerto.",
    ...
    encaja: {
      si: [
        "El mar a dos minutos pesa más que tener el hospital a la vuelta de la esquina. Tapia de Casariego es villa marinera pequeña y cuidada: puerto, casco, isla del faro, paseo costero y playas de surf —Anguileiro, Represas, Serantes; Arnao cerca— casi en la puerta. Quien quiera caminar el casco un martes de noviembre, tomar café junto al puerto y bajar a la orilla cuando el oleaje lo permita encontrará aquí una villa que no se apaga del todo fuera de temporada, aunque la niebla alta forme parte del trato. En agosto Anguileiro y el resto de playas reciben surfistas, toallas y tráfico; hacia el interior del casco el silencio vuelve antes. Unas 1.950 horas de sol y unos cuarenta días despejados —frente a las 2.800 horas y ciento veinte jornadas claras de Mallorca— marcan el contraste con Baleares: verano alrededor de 18,5 °C, agua entre 18 y 20 °C, y el Cantábrico abierto pidiendo días de mar más llana para un baño cómodo. Penarronda, hacia Castropol, amplía dunas cuando apetece otra orilla.",
        "Funciona si se acepta el Hospital de Jarrio, en Coaña, a unos veinte minutos, y el aeropuerto de Asturias alrededor de los setenta. Ribadeo y Navia quedan a unos quince o veinte minutos como apoyo de comercio o villa mayor; la ruta costera hacia Figueras cierra el paseo de frontera. Los servicios de ficha son 4/10 —villa con paseo y vida diaria básica; falta, por ejemplo, instituto de FP—, con fibra sí. A cambio se gana orilla de surf delante, casco compacto y un carácter más marinero que monumental: no es la villa blanca de Luarca, es la de puerto y ola. Quien tenga tiempo libre para el faro, el paseo y las playas, y pruebe un día de niebla densa antes de firmar, entenderá Tapia sin inventarse otro clima.",
      ],
      no: [
        "El hospital a veinte minutos y el aeropuerto a unos setenta no se acortan eligiendo otra calle junto al puerto. Si la prioridad absoluta es Jarrio a diez minutos, Navia lo cubre; si lo que manda es volar a Palma en verano con el trayecto más corto de la zona, Luarca deja Asturias a unos cuarenta minutos. Tapia no compite en esa logística: compite en orilla y casco marinero. Tampoco encaja quien necesite ciudad grande a media hora —Oviedo o Avilés siguen hacia la hora— ni quien quiera el metro más bajo: aquí el precio ronda 1.350 €/m², el más alto de Asturias Occidente.",
        "La niebla alta y el verano fresco cortan el trato si se llega del Mediterráneo esperando cielo abierto y calor de terraza. Quien firme solo un sábado de sol de agosto, sin probar el aparcamiento junto a Anguileiro cuando la costa se llena ni un noviembre de bruma pegada al faro, se llevará una sorpresa. Si lo que se busca es postal indiana, cementerio sobre el acantilado y casco de Luarca, esta villa no lo es; si se busca solo precio mínimo, Castropol queda más bajo. Tapia pide aceptar el Cantábrico de verdad —viento medio, lluvia frecuente, baño corto muchos días— a cambio del surf y el paseo.",
      ],
      veredicto:
        "Veredicto: Tapia encaja como villa marinera de surf y casco cuidado —piso o vivienda caminable a puerto y paseo, fuera del tramo más ocupado de Anguileiro o Serantes en agosto— sobre todo si la orilla delante pesa más que el aeropuerto cerca. Comprobar niebla densa y un sábado de afluencia en la playa antes de firmar. Se ganan faro, ola a dos minutos y villa viva en noviembre; se aceptan unos 1.350 €/m², Jarrio a veinte minutos y Asturias a unos setenta. Quien priorice sanidad a diez minutos, Navia; quien priorice vuelo corto y villa blanca, Luarca.",
    },
    fotosAbrir: [
  ...
  navia: {
    ...
    abrir: [
      ...
      "La semana tiene anclas de villa: mercado, comercio, paseo de ría, bajar a Puerto de Vega cuando apetezca belleza concentrada, Frexulfe o Barayo cuando el día pida orilla más salvaje. Primavera y otoño merecen su visita: la ría se pone verde e intensa; en noviembre la niebla media —más llevadera que en Tapia o Castropol— enseña el cielo real. Quien solo conozca agosto en la playa firmará la orilla; quien haya visto un martes de gestos resueltos firmará —o no— la practicidad.",
      "Fuera de temporada Navia es villa completa y útil. Encaja para quien priorice Jarrio a diez minutos y servicios, y acepte que la postal fuerte a menudo está a cinco minutos, no concentrada en cada esquina del casco.",
    ],
    tiempo: [
    ...
    vivir: [
      ...
      "La vivienda típica es piso o casa de villa práctica junto al paseo o el casco: edificios de uso cotidiano, poca obra nueva y fibra. No es el modelo de Indianos densos de Luarca; es vivienda de semana resuelta. Junto a la ría pesan humedad y ocupación de verano; hacia las afueras, acceso y orientación.",
    ],
    historia: [
      "La ría de Navia y el oficio de villa de servicios explican el municipio mejor que un solo monumento: paseo, comercio, A-8 y una escala que resuelve la semana. Puerto de Vega —pueblo marinero de mirador a cinco minutos— aporta la capa de belleza que el casco no concentra toda en una sola postal.",
      "El castro de Coaña, a unos cinco minutos, añade historia antigua de la comarca: poblado fortificado que se visita en una mañana. Jarrio, en Coaña, convierte la cercanía sanitaria en parte del relato útil de vivir aquí. La historia es de ría, oficio y logística, no de cementerio sobre el acantilado.",
    ],
    fuera: [
      ...
      "Puerto de Vega ofrece mirador y casco marinero sin alejarse: la tarde de postal cuando Navia pide belleza concentrada. Frexulfe —monumento natural— y Barayo —reserva hacia Valdés— amplían el paseo con orillas más abiertas y paisaje protegido.",
    ...
    casa: [
      "El entorno del paseo y el casco ofrecen pisos y viviendas de villa: edificios de uso cotidiano, poca obra nueva y fibra. Junto a la ría pesan humedad y ocupación de verano; hacia las afueras, acceso y orientación. No es el modelo de Indianos densos de Luarca; es vivienda de villa práctica.",
      "El precio medio ronda mil cien euros el metro. Tres habitaciones en la franja asequible se sitúan alrededor de ciento veintinueve mil euros —de las más asequibles de la zona—. La franja media puede ser piso reformado o vivienda con más espacio.",
      "Los servicios son 5/10. Jarrio queda a unos diez minutos. Asturias está a unos cincuenta y cinco, con Palma en verano; Santiago, hacia las dos horas. Eso es Navia: semana resuelta y orilla cerca; el marco de postal se visita a cinco minutos.",
    ],
    encaja: {
      si: [
        "La logística de la zona pesa más que la postal de cementerio sobre el acantilado. Navia es villa de servicios en su ría: paseo, comercio, mercado, centro de salud y hasta cine; playa a unos cinco minutos; Puerto de Vega —pueblo marinero de mirador— a cinco; Frexulfe —monumento natural— y Barayo —reserva hacia Valdés— a un trayecto corto; castro de Coaña cerca. Quien quiera resolver un martes de noviembre sin salir del municipio, bajar a la ría o a la playa cuando apetezca y tener el Hospital de Jarrio, en Coaña, a unos diez minutos —el mejor tiempo de Asturias Occidente— encontrará aquí la casilla práctica. En verano la orilla, Frexulfe, Barayo y Puerto de Vega reciben veraneo, tráfico y terrazas; hacia el interior de la villa el ritmo de trabajo sigue. Unas 1.900 horas de sol y unos cuarenta días despejados —frente a las 2.800 horas y ciento veinte de Mallorca— mantienen el cielo cantábrico: niebla media (más llevadera que en Tapia o Castropol), verano alrededor de 18,5 °C y agua entre 18 y 20 °C. La ría permite baño más usable que el Cantábrico abierto.",
        "Funciona si se acepta menos encanto de marco diario que Luarca a cambio de A-8 a mano, precio alrededor de 1.100 €/m² y aeropuerto de Asturias a unos cincuenta y cinco minutos. Los servicios de ficha son 5/10 —villa completa para el día a día; el atractivo turístico no es el foco—. Quien tenga tiempo libre para Puerto de Vega, el paseo de ría y Frexulfe, y use Navia como base útil más que como postal, entenderá el sitio: la belleza se visita a cinco minutos; la semana se vive en la villa. Palma en verano cabe desde Asturias; Santiago-Lavacolla sigue hacia las dos horas si hace falta casi todo el año.",
      ],
      no: [
        "Si lo que se busca es la villa blanca de la Costa Verde —puerto, siete puentes sobre el río Negro, cementerio y ermita sobre el acantilado, faro e Indianos como marco de cada tarde—, Navia no lo es. Luarca cubre ese carácter; aquí la postal fuerte está en Puerto de Vega o en Frexulfe, no concentrada en el casco. Tampoco encaja quien necesite el aeropuerto a cuarenta minutos: Asturias anda alrededor de los cincuenta y cinco; Luarca gana ese trayecto. Quien firme solo por el hospital cerca, sin probar un agosto en la orilla ni un invierno de cielo cubierto, puede descubrir que la practicidad no compensa si el paisaje diario pedía otra cosa.",
        "El cielo de Baleares no está aquí: llueve con frecuencia, el verano es fresco y Oviedo o Avilés quedan hacia la hora, no a un cuarto de hora. Si la ciudad grande a media hora o el sol mediterráneo son innegociables, esta villa no encaja aunque Jarrio esté a diez minutos. Quien busque solo precio mínimo puede mirar Castropol —alrededor de 1.050 €/m²—, a costa de servicios 3/10 y más distancia a hospital y aeropuerto. Navia pide aceptar menos postal a cambio de la semana resuelta.",
      ],
      veredicto:
        "Veredicto: Navia encaja como apuesta práctica de Asturias Occidente —piso o vivienda caminable a paseo y comercio, con Puerto de Vega cerca para el ocio— sobre todo si Jarrio a diez minutos, A-8 y precio alrededor de 1.100 €/m² pesan más que el marco de villa blanca. Probar un martes de noviembre y un agosto en la orilla antes de firmar. Se ganan hospital cercano, villa útil y Frexulfe o Barayo a un salto; se aceptan menos encanto que Luarca, cielo cantábrico y Asturias a unos cincuenta y cinco minutos. Quien priorice postal y vuelo corto, Luarca; quien priorice orilla de surf cuidada, Tapia.",
    },
    fotosAbrir: [
  ...
  "luarca-valdes": {
    ...
    abrir: [
      ...
      "El tráfico es de villa casi todo el año. En verano el puerto, las playas urbanas y los miradores reciben afluencia, coches y aparcamiento justo. Luarca se conoce por su belleza; las patronales y el veraneo marcan el impacto al vivir —ruido y gente unos días—, sin apagar la villa el resto del año. Quien firme junto al puerto debe probar agosto.",
      "La semana tiene anclas de marco: bajar al puerto, cruzar los puentes del Negro, subir al faro o al cementerio sobre el acantilado, mercado, Jardines de la Fonte Baxa cuando apetezca verde ordenado. Cabo Busto y la ruta de los miradores cierran el paseo de horizonte. Primavera y otoño merecen su visita: la villa blanca se pone intensa de verde; en noviembre la niebla media enseña el trato cantábrico. Quien solo conozca un sábado claro firmará la postal; quien haya visto el puerto lleno y un día gris firmará —o no— la vida.",
    ...
    tiempo: [
      ...
      "El verano ronda dieciocho grados y medio, fresco frente a Baleares. Las playas primera y segunda tienen agua entre dieciocho y veinte grados; Otur, Cueva y Cadavedo amplían opciones. Sigue lejos del Mediterráneo, pero el puerto y los miradores compensan muchos días de baño corto. Conviene probar niebla y un día de afluencia en miradores antes de firmar solo por la postal.",
    ],
    vivir: [
      "El invierno en casa se nota por la niebla media y la humedad del puerto: las casas blancas e indianas piden aislamiento, estado de galerías y orientación, no solo fachada de postal. Una terraza hacia el río Negro o el Cantábrico que en agosto parece el centro de la vida, entre noviembre y febrero se usa a medias. Visitar un día gris y otro de afluencia en miradores vale más que firmar solo por el cementerio sobre el acantilado.",
      ...
      "Conviven gente local, vecinos de Valdés y veraneantes que vuelven cada agosto. Se oye asturiano en el mercado y en la calle; el castellano basta para lo cotidiano, pero la vida social pasa por el casco blanco y el ritmo de villa marinera. Entre semana manda la escala cuidada; en verano el puerto y las playas urbanas suben el volumen con tráfico y aparcamiento justo.",
      ...
      "La vivienda típica es piso o casa blanca en el casco, a veces indiana rehabilitada; las afueras dan más espacio. Hay poca obra nueva y fibra. Las casas de Indianos suben de franja: hay que mirar estado, mantenimiento y humedad, no solo la galería. Junto al puerto pesan salitre y afluencia de temporada.",
    ],
    historia: [
      "El cementerio y la ermita sobre el acantilado, el faro y los siete puentes sobre el río Negro explican Luarca como villa de postal trabajada: piedra, mar y un casco que se reconoce de lejos. No es adorno: es el carácter que la distingue de Navia o Tapia. El río corta la villa; los puentes la cosen.",
      "Las casas de Indianos —quien volvió de América con fortuna— y el mercado añaden capa de villa con prestigio costero: palacetes, galerías, un lujo traído de lejos plantado junto al Cantábrico. Cabo Busto, la ruta de los miradores y los Jardines de la Fonte Baxa completan el relato de paseo y horizonte. La historia útil es de retorno, faro y acantilado, no de industria metropolitana.",
    ],
    fuera: [
      ...
      "La ruta de los miradores y el cementerio sobre el acantilado cierran la postal sin alejarse: prado, precipicio, mar. Otur, Cueva y Cadavedo amplían playa a diez o quince minutos cuando apetece otra arena.",
    ...
    casa: [
      "El casco ofrece pisos y viviendas blancas o indianas; las afueras, más espacio. Hay poca obra nueva y fibra. En el centro pesan turismo de verano y humedad; hacia el puerto, salitre y afluencia de temporada. Las casas de Indianos rehabilitadas suben a la franja media-alta: hay que mirar estado, mantenimiento y orientación, no solo la fachada.",
      "El precio medio ronda mil trescientos euros el metro. Tres habitaciones en la franja asequible se sitúan alrededor de ciento cincuenta y dos mil euros. La franja media puede ser piso reformado en casco o vivienda con vistas al puerto.",

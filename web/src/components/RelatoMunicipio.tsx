...
const RELATOS_BAIXO_MINO: Record<string, RelatoMun> = {
  "a-guarda": {
    ...
    vivir: [
      ...
      "Llegar de fuera es menos dominante que en otras costas: conviven vecinos de toda la vida y veraneantes que vuelven en agosto. Se oye gallego en el mercado y en la lonja; el castellano basta para lo cotidiano. Entre semana manda el ritmo de puerto; en julio y agosto la PO-552 se convierte en un hilo lento. Quien busque solo veraneo firmará la punta; quien busque vecinos todo el año, también los encontrará —con otra escala que Mallorca.",
  ...
  oia: {
    ...
    vivir: [
      ...
      "Mantener el vínculo con Mallorca pasa por el avión desde fuera del municipio. Vigo queda a unos cuarenta y cinco minutos; el relato no fija un aeropuerto a cinco minutos. Conviene mirar el calendario real de vuelos desde Peinador o Santiago y contar el trayecto desde la aldea concreta. En invierno la logística pesa más que en agosto.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Quien descubra el sitio solo en agosto soleado firmará el horizonte y descubrirá en noviembre el precio. Si el tiempo libre se quiere gastar en calle y café compacto, mejor A Guarda (villa de puerto) u O Rosal (valle con plaza); si se quiere mar a la puerta sin soledad, tampoco es esta casilla.",
      ],
      veredicto:
        "Veredicto: Oia no es la casilla de quien busca pueblo compacto ni hospital cerca. Es la de quien quiere océano y silencio y acepta pagarlos en distancia, fibra a comprobar casa por casa y un invierno que vacía las aldeas. Solo si eso es exactamente lo que se busca —y se ha visto un noviembre—; si no, mirar A Guarda (mar con villa) o el valle de O Rosal.",
    },
    fotosAbrir: [
  ...
  "o-rosal": {
    ...
    abrir: [
      ...
      "Aquí el paisaje pesa más que la logística. Quien venga buscando eso —valle, parra, plaza donde se conocen, mar a un cuarto de hora— entenderá el sitio en la primera tarde. Quien venga buscando ciudad a cinco minutos, no.",
  ...
  tui: {
    ...
    tiempo: [
      ...
      "Las mañanas de niebla de río borran el mundo hasta media mañana y luego lo devuelven: no es drama, es el clima de frontera fluvial. La lluvia de octubre a marzo es seria. Quien priorice hospital y ciudad pequeña lo notará al primer día; quien priorice verano fresco y playa a la puerta, también —y entonces Tui no es la casilla.",
    ],
    vivir: [
    ...
    encaja: {
      si: [
        "El hospital público Álvaro Cunqueiro, en Vigo, a unos treinta minutos; la ciudad pequeña —casco empedrado, comercio, tren regional, Valença (Portugal) a pie por el puente internacional, autovía A-55 a Vigo en veinticinco minutos— pesan más que tener el mar a la puerta. Quien tenga tiempo para el casco, para el Monte Aloia los domingos (el primer parque natural de Galicia, pinar y miradores sobre la vega, a unos quince minutos), para cruzar a Valença y usar la villa como base encontrará en Tui la logística más completa de Baixo Miño. El mar queda a unos veinticinco minutos: Cesantes (playa larga en la ría de Vigo, sin olas) o Area Grande (cala de A Guarda). Es salida, no umbral.",

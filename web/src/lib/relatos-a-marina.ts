...
export const RELATOS_A_MARINA: Record<string, RelatoMun> = {
  "o-vicedo": {
    ...
    abrir: [
      ...
      "Fuera de temporada O Vicedo es retiro aislado: pocas mesas, poco comercio y mucho Cantábrico. Primavera y otoño merecen su visita —verde intenso, niebla que entra sin pedir permiso—. Quien solo conozca un sábado de sol se quedará con la foto bonita del horizonte; quien haya visto un noviembre húmedo decidirá —o no— si quiere el aislamiento.",
    ...
    vivir: [
      ...
      "Llegar de fuera busca silencio y mar delante, no comercio a la vuelta de la esquina. Se oye gallego en la villa pequeña; el castellano basta para lo cotidiano, pero la vida social pasa por escala de aldea y ritmos de costa extrema, no por una plaza densa. Entre semana manda el volante; en verano las playas y Fuciño do Porco reciben visitantes y aparcamiento justo. Quien busque solo el horizonte de un sábado de sol se quedará con la foto bonita de la costa; quien busque vecinos densos en enero, mirará Viveiro.",
  ...
  viveiro: {
    ...
    abrir: [
      ...
      "Primavera y otoño merecen su visita: niebla que entra por la ría, eucaliptos del Souto da Retorta, mirador de San Roque. Quien solo conozca un sábado soleado se quedará con la foto bonita del casco; quien haya visto procesiones y un noviembre decidirá —o no— si quiere vivir aquí.",
    ],
    tiempo: [
  ...
  xove: {
    ...
    abrir: [
      ...
      "Fuera de temporada Xove se queda en lo suyo: costa cantábrica, parroquias quietas y dependencia del volante. Quien solo conozca un sábado de sol en Esteiro se quedará con la foto bonita de los arcos; quien haya visto un noviembre vacío decidirá —o no— si quiere vivir a esa escala.",
  ...
  cervo: {
    ...
    abrir: [
      ...
      "Fuera de temporada Cervo recupera ritmo de costa trabajada e industria cercana. Primavera y otoño dejan el Paseo dos Namorados y la ruta del Xunco más quietos. Quien solo conozca un sábado de sol en Cubelas se quedará con la foto bonita de la península; quien haya visto niebla y lonja decidirá —o no— si quiere ese conjunto.",
  ...
  burela: {
    ...
    abrir: [
      ...
      "Fuera de agosto Burela es villa de trabajo: mesas, lonja y hospital delante. Primavera y otoño dejan la orilla más quieta. Quien solo conozca un sábado de sol se quedará con la foto bonita de la playa; quien haya visto un día de lonja en marcha decidirá —o no— si quiere la villa tal cual es.",
  ...
  foz: {
    ...
    abrir: [
      ...
      "Fuera de agosto Foz vuelve a ser una villa calmada. Primavera y otoño dejan la ría más quieta y el verde intenso. Quien solo conozca un sábado de sol se quedará con la foto bonita de A Rapadoira; quien haya visto un noviembre de niebla decidirá —o no— si acepta el gris lucense.",
  ...
  barreiros: {
    ...
    abrir: [
      ...
      "Fuera de temporada Barreiros se queda quieto: calles de bloques vacíos, viento y Cantábrico. Quien solo conozca un sábado de sol en los arcos se quedará con la foto bonita de la costa; quien haya visto un martes de noviembre vacío decidirá —o no— si quiere vivir a esa escala.",
  ...
  ribadeo: {
    ...
    abrir: [
      ...
      "Fuera de agosto Ribadeo es villa de frontera con mesas abiertas, puerto y Castropol enfrente. Primavera y otoño dejan la ría más quieta y el casco indiano más fácil de disfrutar. Quien solo conozca los arcos un sábado de sol se quedará con la foto bonita; quien haya visto niebla y un día de afluencia decidirá —o no— si acepta la logística real.",

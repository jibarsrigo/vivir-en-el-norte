...
export const RELATOS_A_MARINA: Record<string, RelatoMun> = {
  ...
  xove: {
    ...
    casa: [
      ...
      "El precio medio ronda 950 €/m², de los más bajos de la zona, aunque como cifra orientativa: la muestra de anuncios publicados en un municipio disperso de tres mil habitantes puede ser escasa, así que conviene mirar Idealista del mes en que se busque. Tres habitaciones en tipologías modestas quedan en franja muy asequible —alrededor de 111.000 euros, estimados a partir del €/m² y no tomados de un anuncio concreto—; el estado de la reforma importa más que una media única.",
  ...
  burela: {
    ...
    casa: [
      ...
      "El precio medio ronda unos 1.200 €/m² (cifra orientativa; conviene contrastar Idealista del mes). Tres habitaciones en la franja asequible se sitúan alrededor de 140.000 euros. La franja media es piso ampliado o vivienda con mejor orientación; el estado pesa.",
  ...
  barreiros: {
    ...
    casa: [
      ...
      "El precio medio ronda unos 1.150 €/m² (cifra orientativa; la muestra puede ser escasa — contrastar Idealista del mes). Tres habitaciones en tipologías de apartamento o vivienda modesta quedan en franja asequible —alrededor de 135.000 euros—; el estado y la orientación al mar mueven el precio.",

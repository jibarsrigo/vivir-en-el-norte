  ...
  return (
    <article className="mt-8">
      <section>
        ...
        <P>
          Es la zona más espectacular de paisaje de las costas publicadas hasta aquí —y la peor
          en sol—. Gijón queda a veinticinco o cincuenta minutos; Oviedo, a cuarenta o setenta;
          Torrelavega y Santander, a cuarenta y cinco o setenta y cinco desde Ribadedeva. Sanidad
          y aeropuerto están en el límite de lo práctico.
        </P>
        <Foto
      ...
      <section>
        ...
        <P>
          ...
          {zona.despejados} días despejados al año —en la franja de 1.700 a 1.750 horas y unos 40
          despejados, el mínimo de la tabla junto con Cantabria—. Mallorca ronda{" "}
        ...
        <P>
          ...
          en la franja de 1.200 a 1.300 mm y 153 a 155 días—, con unos {zona.cubiertos} cubiertos.
          También en verano llueve {zona.lluvia.verano} días al mes. El viento es bajo —la sierra
          protege—; la niebla es media en Villaviciosa.
        </P>
        <P>
          El verano es fresco: la media ronda {zona.tempVerano} °C, las máximas habituales unos
          23-24 °C y apenas uno a tres días superan los 30 °C. Frente al calor sostenido balear se
          duerme fresco —y se acepta el cielo más opuesto a Mallorca de toda la tabla—.
        </P>
        <P>
          El agua anda entre 19 y 21 °C en agosto. Rodiles, La Griega, Santa Marina, Toró, Sablón,
          Barro, Gulpiyuri o La Franca invitan al paseo y al baño cuando el mar lo permite; muchas
          playas son pequeñas y abrigadas entre acantilados.
        </P>
        <p className="mt-4 max-w-2xl font-semibold text-[var(--calor)]">
          Verano fresco: media alrededor de 19,5 °C y apenas uno a tres días por encima de 30 °C.
        </p>
      </section>
      ...
      <section>
        <H2>Cómo se vive</H2>
        <P>
          Un martes de noviembre muestra escalas distintas. Llanes y Ribadesella alcanzan 7/10:
          villas completas con centro de salud, comercio, mercado y mesas abiertas. Villaviciosa
          también 7/10 —villa de servicios con vida propia—. Colunga baja a 4/10; Ribadedeva, a
          3/10 —Unquera y Colombres cubren lo básico; Llanes queda a unos quince minutos—.
        </P>
        <P>
      ...
      <section>
        ...
        <P>
          En Villaviciosa, la ría —paseo y aves—, Tazones y Rodiles —playa larga con pinar y
          surf— cubren orilla a doce minutos; Valdediós —prerrománico— queda tierra adentro a
          unos diez. Colunga aporta Lastres, La Griega —huellas de dinosaurio—, La Isla y el
          Sueve con el Mirador del Fitu —una de las vistas mar-montaña más famosas de España—.
        </P>
        <P>
        ...
        <P>
          ...
          minutos. Para un caminante es la mejor zona de la tabla: sierra sobre el mar y montaña
          real cerca.
        </P>
        <Foto
      ...
      <section>
        ...
        <P>
          Asturias Oriente cubre franjas distintas. Villaviciosa ronda 1.500 €/m²; Ribadedeva,
          1.600; Colunga, 1.700; Llanes, 2.100; Ribadesella, 2.200. Tres habitaciones en la
          franja asequible se sitúan aproximadamente entre 142.000 euros en Villaviciosa y
          246.000 en Llanes villa; en Ribadesella ronda 257.000. En Llanes, los pueblos con playa
          —Barro, Niembro, Celorio— encarecen respecto a la villa y a los pueblos interiores.
        </P>
        <P>
      ...
      <section>
        ...
        <P>
          Llanes, Ribadesella y Villaviciosa alcanzan 7/10; Colunga, 4/10; Ribadedeva, 3/10.
          Servicios significa vida diaria dentro del municipio —tiendas, farmacia, centro de
          salud, súper—, no la distancia al hospital. Gijón cubre desde Villaviciosa; Llanes,
          desde Ribadedeva; Oviedo queda a cuarenta o setenta minutos.
        </P>
        <P>
          ...
          Villaviciosa; desde el resto, a cuarenta y cinco o sesenta. Es la sanidad más débil de
          la tabla después de A Mariña.
        </P>
        <P>
          ...
          Ribadesella y Llanes. Santander —Palma casi todo el año— es mejor hacia el este: unos
      ...
      <Encaja
        si={[
          "Se busca el paisaje más espectacular de la tabla —sierra sobre el mar y Picos a media hora—, aceptando el sol más bajo y sanidad y aeropuerto en el límite. Ribadesella gana como villa equilibrada; Villaviciosa, como opción práctica con Gijón y Cabueñes a veinticinco minutos.",
          "Se valora caminar ría, playa abrigada y montaña real —Fitu, Cuera, Covadonga—, con villas de piedra e Indianos y un mercado que aún deja franjas asequibles en Villaviciosa, Ribadedeva y Colunga.",
        ]}
        no={[
          `Se necesita el cielo de Baleares: Asturias Oriente tiene ${zona.lluviaDias} días de lluvia, ${zona.despejados} despejados y ${zona.cubiertos} cubiertos, frente a ${mallorca.lluviaDias} y ${mallorca.despejados} en Mallorca. Es el clima más opuesto a Mallorca de toda la tabla.`,
        ...
        veredicto="Veredicto de zona: Asturias Oriente gana por paisaje —montaña que cae al mar y Picos cerca—, no por sol ni por logística. Si un día los Picos pesan más que el cielo balear, Ribadesella o Villaviciosa son las apuestas más equilibradas; Llanes, la villa más completa y bonita del oriente a cambio de agosto lleno y Arriondas a treinta y cinco minutos; Colunga, Lastres y el Fitu con coche; Ribadedeva, Indianos y Santander a cincuenta y cinco. Antes de elegir, probaría un noviembre cubierto, un Descenso del Sella o un agosto en Llanes o Ribadesella."
      />

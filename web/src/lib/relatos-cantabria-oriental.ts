...
export const RELATOS_CANTABRIA_ORIENTAL: Record<string, RelatoMun> = {
  ...
  noja: {
    ...
    casa: [
      ...
      "El precio medio ronda 2.300 €/m². Tres habitaciones en primera línea se sitúan alrededor de 269.000 euros —fuera de la orilla asequible habitual—. Conviene probar el vacío de noviembre y el aparcamiento de agosto antes de comprar como si fuera villa de invierno.",
  ...
  santona: {
    ...
    casa: [
      ...
      "El precio medio ronda 1.900 €/m² —el más asequible de la zona—. Tres habitaciones en la franja asequible se sitúan alrededor de 222.000 euros; dos habitaciones, cerca de 160.000. Conviene probar un martes de lonja y un agosto en Berria antes de comprar.",
  ...
  laredo: {
    ...
    casa: [
      ...
      "El precio medio ronda 2.100 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 246.000 euros; dos habitaciones, cerca de 177.000. La franja media puede ser piso algo retirado del frente más ocupado. Conviene probar agosto en La Salvé y un noviembre de villa antes de comprar.",
  ...
  "castro-urdiales": {
    ...
    casa: [
      ...
      "El precio medio ronda 2.400 €/m². Tres habitaciones se sitúan alrededor de 281.000 euros —fuera de la orilla asequible habitual—. La franja media puede ser piso de dos habitaciones o vivienda algo retirada de Brazomar. Conviene probar un noviembre cubierto y el tráfico hacia Bilbao antes de comprar.",

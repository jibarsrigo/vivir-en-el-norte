...
export const RELATOS_ASTURIAS_OCCIDENTE: Record<string, RelatoMun> = {
  ...
  "tapia-de-casariego": {
    ...
    abrir: [
      ...
      "La semana tiene anclas de puerto: lonja o pez fresco cuando toca, café junto a la dársena, paseo hacia el faro, bajar a la ola cuando el Cantábrico lo permita. La ruta costera hacia Figueras cierra el trayecto de frontera. Primavera y otoño merecen su visita: el verde de la costa occidental se pone intenso; en noviembre la niebla alta enseña el trato real. Quien solo conozca un sábado de sol en Anguileiro se quedará con la foto bonita; quien haya visto un día de bruma pegada al faro decidirá —o no— si quiere vivir aquí.",
  ...
  navia: {
    ...
    abrir: [
      ...
      "La semana tiene anclas de villa: mercado, comercio, paseo de ría, bajar a Puerto de Vega cuando apetezca belleza concentrada, Frexulfe o Barayo cuando el día pida orilla más salvaje. Primavera y otoño merecen su visita: la ría se pone verde e intensa; en noviembre la niebla media —más llevadera que en Tapia o Castropol— enseña el cielo real. Quien solo conozca agosto en la playa se quedará con la foto bonita de la orilla; quien haya visto un martes de gestos resueltos decidirá —o no— si quiere esa practicidad.",
  ...
  "luarca-valdes": {
    ...
    abrir: [
      ...
      "La semana tiene anclas de marco: bajar al puerto, cruzar los puentes del Negro, subir al faro o al cementerio sobre el acantilado, mercado, Jardines de la Fonte Baxa cuando apetezca verde ordenado. Cabo Busto y la ruta de los miradores cierran el paseo de horizonte. Primavera y otoño merecen su visita: la villa blanca se pone intensa de verde; en noviembre la niebla media enseña el trato cantábrico. Quien solo conozca un sábado claro se quedará con la foto bonita; quien haya visto el puerto lleno y un día gris decidirá —o no— si quiere vivir aquí.",
    ...
    encaja: {
      ...
      no: [
        "Jarrio a veinte minutos no es Jarrio a diez: eso es Navia. Si la prioridad absoluta es sanidad comarcal al cuarto de hora, esta villa no encaja aunque el faro esté en la puerta. Tampoco encaja quien busque solo el metro más bajo —Castropol anda alrededor de 1.050 €/m²— o quien necesite ciudad grande a media hora: Oviedo y Avilés siguen hacia la hora. Las casas de Indianos rehabilitadas suben de franja; quien firme esperando gangas de pueblo sin mirar estado y humedad se equivoca de opción.",

...
export const RELATOS_ASTURIAS_ORIENTE: Record<string, RelatoMun> = {
  ...
  colunga: {
    ...
    abrir: [
      ...
      "La semana tiene anclas distintas a las de una villa: el coche abre el mapa —Lastres, La Griega, el Fitu— y Arriondas resuelve hospital y gestos comarcales. Primavera y otoño merecen su visita: el Sueve cambia de color y el mirador enseña el trato sin el atasco de agosto. Quien solo conozca el Fitu un día despejado se quedará con la foto bonita; quien haya visto un martes vacío y un sábado de Lastres lleno decidirá —o no— si quiere vivir aquí.",
  ...
  ribadesella: {
    ...
    vivir: [
      ...
      "Conviven gente local, vecinos de toda la vida y veraneantes que vuelven cada julio y agosto. Se oye asturiano en el mercado y en el puerto; el castellano basta para lo cotidiano. La vida social pasa por el Sella, los soportales y el día a día de villa —incluido el Descenso del Sella el primer sábado de agosto—. Entre semana manda la escala local; en temporada alta la población se multiplica.",
    ...
    fuera: [
      ...
      "A unos diez minutos, Vega cubre playa distinta: más abierta, otra escala de orilla. El agua anda entre 19 y 21 °C; se entra, se nada, se sale con la piel despabilada. Tito Bustillo aporta la cueva cuando hay visita posible: otra tarde, otro ambiente. En temporada alta la afluencia hacia playa y Picos se nota en la carretera; fuera de agosto, la villa recupera calma.",
    ...
    encaja: {
      ...
      no: [
        "Julio y agosto no son noviembre: si la calma en temporada alta es innegociable, esta villa no encaja aunque el casco sea precioso. Llanes sufre el mismo golpe de veraneo; Villaviciosa y Ribadedeva lo viven con menos intensidad. Tampoco encaja quien busque tres habitaciones pegadas a Santa Marina en franja muy asequible: el metro más alto de la zona y la orilla de Indianos empujan el precio. Quien se decida solo con por un día de sol en el paseo, sin probar el atasco de coches del Descenso ni un invierno de cielo cubierto, se llevará una sorpresa.",
  ...
  ribadedeva: {
    ...
    abrir: [
      ...
      "La semana tiene anclas distintas a las de una villa: el coche abre Unquera, Llanes a quince minutos, La Franca, La Hermida y los Picos. Primavera y otoño merecen su visita: Tina Mayor y el desfiladero cambian de luz sin el tráfico de temporada hacia los Picos. Quien solo conozca la Quinta un día despejado se quedará con la foto bonita de Indianos; quien haya visto un noviembre vacío y la dependencia del volante decidirá —o no— si quiere vivir aquí.",

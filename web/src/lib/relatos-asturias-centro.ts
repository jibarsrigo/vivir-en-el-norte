  ...
  "luanco-gozon": {
    ...
    encaja: {
      si: [
        ...
        "El clima es el extremo algo más soleado de la zona —unas 1.850 horas de sol y 42 días despejados—, pero sigue lejos de Mallorca (2.800 horas y 120 jornadas claras): caen alrededor de 1.000 milímetros en unos 145 días, con niebla baja y viento medio en la costa de Peñas. El verano ronda 19 °C: se gana frescura y se acepta cielo cubierto frecuente. En verano La Ribera, Aramar y Xagó reciben toallas, tráfico y afluencia de villa marinera con veraneo ovetense; fuera de temporada Luanco vuelve a ser una villa cuidada. Encaja si has probado un día de viento en Peñas y un agosto en La Ribera y siga queriendo ese casco —tres habitaciones en la franja asequible alrededor de 211.000 euros; precio medio cerca de 1.800 €/m²— con aeropuerto a unos veinte minutos.",
      ],
      no: [

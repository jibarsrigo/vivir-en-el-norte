...
export const RELATOS_ALTO_MINHO: Record<string, RelatoMun> = {
  ...
  "moledo-caminha": {
    ...
    casa: [
      ...
      "El precio medio ronda 2.300 €/m². Tres habitaciones se sitúan alrededor de 269.000 euros —fuera de la orilla asequible habitual de la zona—. Dos habitaciones en la franja asequible rondan unos 194.000 euros. Quien necesite tres habitaciones baratas junto al mar deberá mirar otra opción.",
  ...
  "vila-praia-de-ancora": {
    ...
    encaja: {
      ...
      veredicto:
        "Veredicto: Vila Praia de Âncora es la villa marinera abrigada del Alto Minho —puerto, mercado y espigón a cambio de veraneo de agosto y mar frío—. Buscaría tres habitaciones hacia el casco o algo retiradas del frente más ocupado, tras probar un martes de noviembre y un día de afluencia en la orilla. Se ganan playa abrigada, servicios 6/10, tren y hospital a unos veinte minutos; se aceptan ~2.000 €/m², agua a 16–18 °C y seguro privado portugués. Si mandan granito, monte y silencio de aldea, Afife-Carreço; si hay que contar con ciudad completa, Viana; si la prioridad es vivir junto al mar con recados a pie, Âncora es la opción más coherente de la costa.",
    },
    fotosAbrir: [

...
export const RELATOS_LITORAL_NORTE: Record<string, RelatoMun> = {
  esposende: {
    ...
    abrir: [
      ...
      "La semana tiene anclas: paseo del estuario, supermercado y centro de salud en la villa, pasarelas del parque cuando el cielo limpia. Primavera y otoño merecen su visita: las dunas sin gentío, Fão con día a día de villa antigua, el Cávado ancho. Quien solo conozca un sábado de sol en Apúlia se quedará con la foto bonita; quien haya visto un julio con nortada y un martes gris de noviembre decidirá —o no— si quiere vivir aquí.",
  ...
  "povoa-de-varzim": {
    ...
    abrir: [
      ...
      "La semana tiene anclas: paseo, mercado, metro, puerto. Primavera y otoño merecen su visita: el Atlántico sin gentío, el casino sin cola de agosto, Porto a media hora sin la A28 saturada. Quien solo conozca un día de sol en Redonda se quedará con la foto bonita; quien haya visto un agosto lleno y un martes gris de noviembre decidirá —o no— si quiere vivir aquí.",
  ...
  "vila-do-conde": {
    ...
    abrir: [
      ...
      "La semana tiene anclas: Santa Clara, acueducto, mercado, metro, orilla del Ave. Primavera y otoño merecen su visita: el casco sin gentío de agosto, Mindelo con aves, Azurara con menos tablas. Quien solo conozca Santa Clara un día de sol se quedará con la foto bonita del monumento; quien haya visto un agosto en Azurara y un martes gris junto al río decidirá —o no— si quiere vivir aquí.",

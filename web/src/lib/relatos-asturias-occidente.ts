...
export const RELATOS_ASTURIAS_OCCIDENTE: Record<string, RelatoMun> = {
  ...
  "luarca-valdes": {
    ...
    encaja: {
      ...
      no: [
        "Jarrio a veinte minutos no es Jarrio a diez: eso es Navia. Si la prioridad absoluta es sanidad comarcal al cuarto de hora, esta villa no encaja aunque el faro esté en la puerta. Tampoco encaja quien busque solo el precio más bajo —Castropol anda alrededor de 1.050 €/m²— o quien necesite ciudad grande a media hora: Oviedo y Avilés siguen hacia la hora. Las casas de Indianos rehabilitadas suben de franja; quien compre esperando gangas de pueblo sin mirar estado y humedad se equivoca de opción.",

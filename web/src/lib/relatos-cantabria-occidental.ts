...
export const RELATOS_CANTABRIA_OCCIDENTAL: Record<string, RelatoMun> = {
  ...
  comillas: {
    ...
    casa: [
      ...
      "El precio medio ronda 2.400 €/m². Tres habitaciones se sitúan alrededor de 281.000 euros —fuera de la orilla asequible habitual—. La franja media puede ser piso reformado en casco o vivienda algo retirada de la playa. Conviene probar el aparcamiento de agosto y el silencio de noviembre antes de comprar.",
  ...
  santander: {
    ...
    casa: [
      ...
      "El precio medio ronda 2.600 €/m². Tres habitaciones se sitúan alrededor de 304.000 euros —fuera de la orilla asequible habitual—. La franja media puede ser piso de dos habitaciones en ensanche o cerca del Sardinero. Conviene probar un invierno de cielo cubierto y un agosto en la playa antes de comprar.",

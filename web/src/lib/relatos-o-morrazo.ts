 ...
 creditoFotos: "Fotos: Wikimedia Commons (licencias indicadas en los archivos de origen).",
  ...
  moana: {
    ...
    abrir: [
      ...
      "La villa tiene servicios básicos completos, pero no la densidad comercial de Cangas ni la cercanía hospitalaria de Marín. Montecelo queda a unos treinta minutos; el barco no resuelve una urgencia en coche. Quien se decida solo tras un sábado de sol en A Xunqueira, sin medir sol de invierno en una casa alta ni el tráfico de Rande un lunes, se llevará una sorpresa.",
    ],
    tiempo: [
    ...
    vivir: [
      "El invierno en Moaña se siente en la humedad de la ría y en las casas altas con menos sol. En Mallorca muchas viviendas casi no piensan en calefacción ni en moho; aquí caen alrededor de 1.550 milímetros en 128 días. Conviene medir orientación: una vista abierta a Vigo trae luz; una finca detrás del monte puede perder sol temprano. Visitar en noviembre húmedo enseña más que un martes soleado en el paseo.",
    ...
    encaja: {
      ...
      no: [
        ...
        "El puente de Rande puede atascarse en hora punta y el hospital público queda cerca del límite deseable, a unos treinta minutos —el barco no resuelve una urgencia en coche—. Marín funciona mejor si sanidad y Pontevedra importan más que Vigo. Quien se decida solo tras un sábado de sol en A Xunqueira, sin medir sol de invierno en una casa alta ni el tráfico de Rande un lunes, se llevará una sorpresa. Cangas ofrece más Costa da Vela; Bueu, más calma hacia Ons.",
      ],
      veredicto:

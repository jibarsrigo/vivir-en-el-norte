  ...
  llanes: {
    ...
    encaja: {
      si: [
        ...
        "Funciona si se acepta el Hospital del Oriente, en Arriondas, a unos treinta y cinco minutos —peor que Colunga o Ribadesella a veinte— y se mira Santander a unos setenta minutos como puerta a Palma casi todo el año, frente a Asturias alrededor de ochenta y cinco. El metro ronda 2.100 €/m²: tres habitaciones en la villa pueden entrar en franja usable; en Barro, Niembro o Celorio el precio de orilla suele saltar de franja. Quien priorice muro, Cuera, bufones y playas sin número, y pruebe un agosto saturado y un noviembre vacío antes de comprar, entenderá Llanes: gana por villa y orillas, no por despejados ni por sanidad cercana.",
      ],
      no: [

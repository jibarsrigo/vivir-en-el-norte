...
export const RELATOS_ASTURIAS_CENTRO: Record<string, RelatoMun> = {
  cudillero: {
    ...
    abrir: [
      "Cudillero reúne unos cinco mil habitantes en el concejo, en la costa occidental del área metropolitana asturiana. El pueblo que sale en las postales es un anfiteatro de casas colgadas sobre el puerto: calles en cuesta, tejados a distintas alturas y el Cantábrico abajo, siempre a la vista. Quien llega de día encuentra el casco lleno de visitantes; quien se queda a vivir descubre que esas mismas cuestas pesan en la compra, en la vuelta con bolsas y en cualquier tarde de lluvia. Arriba, El Pito —llano, hacia Muros de Nalón— cambia la ecuación: el horizonte sigue cerca, pero la calle deja de ser un anfiteatro.",
    ...
    fuera: [
      "Aguilar y Concha de Artedo cubren la playa a unos cinco minutos del núcleo: orillas de uso diario cuando el mar lo permite, con agua entre 19 y 21 °C. No son calas de postal vacía en agosto; son la costa cercana del concejo, la que se usa entre semana cuando el casco colgado está más calmado.",
  ...
  "muros-de-nalon": {
    ...
    abrir: [
      "Muros de Nalón reúne unos mil ochocientos habitantes en la orilla oeste de la desembocadura del Nalón, el gran río que llega al Cantábrico entre este concejo y Soto del Barco. No es villa de paseo comercial denso ni pueblo colgado de postal: es estuario, horizonte y la Ruta de los Miradores —siete miradores sobre la desembocadura— como paseo de diario. La playa de Aguilar queda a unos cinco minutos; el precio es de los más bajos de Asturias Centro. Quien busca ruido de terrazas encontrará poco; quien busca silencio sobre el agua encontrará el tono del lugar.",
    ...
    vivir: [
      "El invierno en casa se nota por la humedad de desembocadura y la niebla media sobre el Nalón: paredes, armarios y orientación hacia el estuario importan más que la postal de los miradores. Una terraza de agosto no garantiza uso de noviembre. Visitar un martes vacío enseña el precio real del silencio.",
      ...
      "La vivienda típica es casa o piso de concejo pequeño hacia el estuario y las parroquias, sin obra nueva. La fibra es parcial —conviene comprobar casa por casa—. Se compra silencio y cercanía al aeropuerto; pesan humedad de ría, acceso y la distancia real a un súper completo.",
    ],
    historia: [
      "La desembocadura del Nalón y la Ruta de los Miradores explican Muros: concejo de estuario y horizonte, no de casco monumental. Los siete miradores no son adorno turístico aislado; son el relato útil del día a día —paseo, luz sobre el río, frontera visual con Soto al otro lado—.",
    ...
    casa: [
      "Predominan viviendas hacia el estuario y las parroquias: casas y pisos de concejo pequeño, sin obra nueva. La fibra es parcial —conviene comprobar casa por casa—. Pesan humedad de ría, acceso, orientación hacia el Nalón y la distancia real a un súper completo.",
      "El precio medio ronda 1.100 €/m², el más bajo de la zona. Tres habitaciones en tipologías modestas quedan alrededor de 129.000 euros. Se compra silencio y cercanía al aeropuerto; no se compra autosuficiencia de villa.",
  ...
  "soto-del-barco": {
    ...
    abrir: [
      ...
      "Soto encaja para quien quiera estuario tranquilo, playa larga y aeropuerto a diez minutos, con precio todavía asequible —y con fibra parcial comprobada antes de firmar—.",
    ],
    tiempo: [
    ...
    vivir: [
      "El invierno en casa se nota por la humedad de ría y la niebla media sobre el estuario: junto a Los Quebrantos o San Juan de la Arena pesan salitre y humedad; hacia el interior, acceso y orientación. Conviene tocar paredes un día húmedo y no firmar solo con sol de folleto en la playa larga.",
      ...
      "La vivienda típica es piso o casa de concejo hacia San Juan de la Arena y el estuario, sin obra nueva. La fibra es parcial —hay que comprobarla—. Junto a la playa pesan ocupación de verano, salitre y humedad; se compra orilla usable y logística de aeropuerto, no la densidad de servicios de Salinas.",
    ],
    historia: [
      "San Juan de la Arena y el oficio marinero del estuario explican Soto: pueblo de desembocadura, angulas y playa larga, no de casco indiano denso ni de anfiteatro de postal. La relación con el Nalón —río, marea, oficio— es el hilo útil del lugar.",
    ...
    casa: [
      "El entorno de San Juan de la Arena y el estuario ofrecen viviendas de villa y parroquia: pisos y casas de concejo, sin obra nueva. La fibra es parcial. Junto a la playa pesan ocupación de verano, salitre y humedad; hacia el interior del estuario, acceso y distancia real a Avilés.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco si el cielo de Baleares es imprescindible o si se necesita vida diaria sin coche. Aquí mandan cubierto (unos 165 días), niebla media y verano fresco; Avilés resuelve muchos recados. Quien firme solo un día soleado en Los Quebrantos, sin probar ocupación de temporada ni un noviembre de ría, se llevará una sorpresa.",
      ],
      veredicto:
  ...
  "salinas-castrillon": {
    ...
    historia: [
      ...
      "Avilés cercano —casco histórico y Centro Niemeyer— añade capa de ciudad a diez minutos: comercio, cultura contemporánea y hospital. La historia útil de Salinas es de orilla residencial y área metropolitana, no de fortaleza ni de anfiteatro de postal.",
    ...
    casa: [
      "Predominan casas bajas y chalés; hay poca obra nueva y fibra. Junto al paseo pesan ocupación de verano, salitre y aparcamiento; hacia el interior de la villa, orientación, distancia real a la playa y si la manzana sigue siendo caminable en enero.",
      "El precio medio ronda 1.700 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 199.000 euros. La franja media puede ser chalé reformado o vivienda más cerca del paseo. La facilidad de venta es alta en el área; el precio compra villa-playa y logística, no silencio garantizado en agosto.",
  ...
  "luanco-gozon": {
    ...
    abrir: [
      ...
      "Un martes de noviembre se camina el casco y se resuelve lo básico. Los servicios alcanzan 5/10: hay fibra y ritmo de villa cuidada, sin sustituir el comercio denso de Avilés o Gijón. El Hospital de Jove, en Gijón, queda a unos quince minutos; San Agustín, en Avilés, a unos veinte. El aeropuerto de Asturias anda alrededor de los veinte minutos, con Palma en verano.",
      "En verano La Ribera, Aramar y Xagó reciben toallas, tráfico y afluencia de villa marinera. Las patronales y el veraneo marcan ruido y aparcamiento justo unos días. Fuera de temporada Luanco recupera ritmo de villa cuidada: piedra, puerto y vecinos que conocen el viento medio de la costa de Peñas.",
    ...
    vivir: [
      "El invierno en casa se nota por el viento medio de la costa de Peñas y el salitre del casco: niebla baja, pero mañanas grises y terraza que se usa a medias entre noviembre y febrero. Conviene mirar orientación hacia La Ribera o calles más interiores, no solo la postal de piedra. Visitar un día de viento en el cabo enseña el trato real.",
      ...
      "La vivienda típica es piso o casa de villa marinera en el casco, con poca obra nueva y fibra. Junto a la orilla pesan salitre, viento de cabo y ocupación de verano; hacia calles más interiores, acceso y distancia real a La Ribera. Se compra carácter marinero, no la logística completa de Salinas.",
    ],
    historia: [
      "El casco de piedra y el Museo Marítimo explican Luanco como villa de oficio del mar y de postal costera del Cabo Peñas. No es adorno: es el carácter que la distingue de Salinas —villa-paseo residencial— o de Gijón —ciudad—. Puerto, piedra y museo cuentan continuidad marinera.",
      "El faro y los acantilados de Peñas sitúan Gozón en la costa más abierta del área metropolitana: senda, horizonte y oleaje. La historia útil es marinera y de cabo, no de industria urbana ni de estuario fluvial.",
    ...
    fuera: [
      "La Ribera y Aramar son las orillas de diario: playas urbanas a pie, agua entre 19 y 21 °C, terrazas y ritmo de villa cuando el verano no las satura. El Museo Marítimo y el casco permiten una tarde sin coche —piedra, puerto, memoria del oficio—.",
    ...
    casa: [
      "El casco ofrece pisos y viviendas de villa marinera; hay poca obra nueva y fibra. Junto a la orilla pesan salitre, viento de cabo y ocupación de verano; hacia calles más interiores, acceso y distancia real a La Ribera.",
      "El precio medio ronda 1.800 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 211.000 euros. La franja media puede ser piso reformado en casco o vivienda con mejores vistas. Se compra carácter marinero; no se compra la logística completa de Salinas.",
    ...
    encaja: {
      si: [
        ...
        "El clima es el extremo algo más soleado de la zona —unas 1.850 horas de sol y 42 días despejados—, pero sigue lejos de Mallorca (2.800 horas y 120 jornadas claras): caen alrededor de 1.000 milímetros en unos 145 días, con niebla baja y viento medio en la costa de Peñas. El verano ronda 19 °C: se gana frescura y se acepta cielo cubierto frecuente. En verano La Ribera, Aramar y Xagó reciben toallas, tráfico y afluencia de villa marinera con veraneo ovetense; fuera de temporada Luanco recupera ritmo de villa cuidada. Encaja quien haya probado un día de viento en Peñas y un agosto en La Ribera y siga queriendo ese casco —tres habitaciones en la franja asequible alrededor de 211.000 euros; precio medio cerca de 1.800 €/m²— con aeropuerto a unos veinte minutos.",
      ],
      no: [
        ...
        "Tampoco si se necesita el sol de Baleares o evitar el viento medio de la costa de Peñas. Aquí mandan cubierto (unos 165 días) y verano fresco; el cabo no es bahía abrigada. Quien firme solo un sábado soleado en el casco de piedra, sin probar oleaje y viento en Peñas ni ocupación de agosto en La Ribera, se llevará una villa distinta de la postal.",
      ],
      veredicto:
  ...
  "candas-carreno": {
    ...
    abrir: [
      ...
      "Quien firme hacia el oeste debe probar un día con el viento que trae el aire de Aboño; quien mire hacia el puerto y Palmera debe conocer también un martes vacío. Candás no es el silencio del estuario ni el paseo de chalés de Salinas: es villa marinera metropolitana, con industria vecina en el trato.",
    ...
    vivir: [
      ...
      "La vivienda típica es piso o casa de villa junto al casco o al puerto, con poca obra nueva y fibra. Junto a la orilla pesan salitre y ocupación de verano; hacia Aboño, el aire según el viento y la distancia real a la industria. Hay que imaginar la rutina con ese vecino industrial, no solo con el faro.",
    ],
    historia: [
      "El puerto, el faro y el Museo Antón explican Candás como villa marinera con capa de cultura local, pegada a Gijón. El oficio del mar y la cercanía a la ciudad marcan el carácter: no es postal aislada ni barrio dormitorio sin orilla.",
      "Aboño —central térmica y cementera— forma parte del relato honesto de vivir aquí: no es postal, es el vecino industrial del oeste de Carreño y del borde de Gijón. La historia útil combina puerto, tren y área metropolitana con industria pesada a la vista.",
    ...
    casa: [
      "El casco y el entorno del puerto ofrecen pisos y viviendas de villa; hay poca obra nueva y fibra. Junto a la orilla pesan salitre y ocupación de verano; hacia Aboño, el aire según el viento y la distancia real a la central.",
      "El precio medio ronda 1.650 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 193.000 euros. Se compra villa marinera junto a Gijón; no se compra aire limpio garantizado todos los días hacia el oeste.",
  ...
  gijon: {
    ...
    abrir: [
      ...
      "Para escala de casas bajas cerca de la playa, Somió —chalés a unos cinco minutos de la orilla— es la versión urbanización dentro del municipio, a precio alto. Quien quiera ciudad completa encontrará aquí la orilla más densa de Asturias Centro; quien busque silencio de estuario o postal de Cudillero mirará otro mapa.",
    ...
    historia: [
      ...
      "La Senda del Cervigón, el Cerro de Santa Catalina, el Jardín Botánico Atlántico y el Parque de Isabel la Católica completan el relato de ciudad caminable junto al Cantábrico: acantilado urbano, mirador y verde sin salir del municipio.",
      "Lo que queda para quien llega a vivir es esa densidad: playa urbana, barrio antiguo, ensanche y, en Somió, casas bajas a precio alto. La historia útil es de ciudad de mar, no de concejo pequeño.",
    ],
    fuera: [
    ...
    casa: [
      "Hay pisos de ciudad, obra nueva y fibra. Junto a San Lorenzo pesan precio, afluencia y salitre; en Somió, chalés y casas bajas a precio alto. Tres habitaciones en primera línea urbana suelen quedar fuera de la franja asequible; entran a cinco o diez minutos de la playa.",
      "El precio medio ronda 2.300 €/m², el más alto de la zona. Dos habitaciones en la franja asequible se sitúan alrededor de 194.000 euros; tres habitaciones, alrededor de 269.000. La compra realista cerca del mar suele ser piso a unos minutos de la orilla, no primera línea barata.",
    ...
    encaja: {
      si: [
        "Encaja para quien quiera ciudad de mar completa todo el año —San Lorenzo con el paseo del Muro, Cimadevilla, Poniente, parques, universidad, cultura y comercio— y priorice servicios 10/10 frente a villa pequeña. Un martes de noviembre se resuelve todo en el municipio: Cabueñes y Jove quedan a unos cinco minutos; la dependencia del coche es baja. Quien busque playa urbana usable (agua entre 19 y 21 °C), vida cultural y hospital a la vuelta de la esquina encontrará aquí la urbe abierta de Asturias, no un estuario silencioso ni un anfiteatro de postal. El precio es el más alto de la zona —alrededor de 2.300 €/m²—: dos habitaciones en franja asequible cerca de 194.000 euros; tres habitaciones alrededor de 269.000, suelen entrar a cinco o diez minutos de la playa, no en primera línea.",
      ...
      no: [
        "No encaja si se busca villa pequeña, estuario silencioso o el precio de Muros (1.100 €/m²) y Soto (1.200). Tampoco si tres habitaciones en primera línea de San Lorenzo deben entrar en franja asequible: esa tipología suele quedar fuera; la compra real asequible pide alejarse unos minutos de la orilla. El aeropuerto de Asturias queda a unos treinta minutos —peor tiempo de la zona—; Palma en verano, no todo el año.",
        "Tampoco si se necesita el sol de Baleares o aire limpio garantizado hacia el oeste. Gijón gana por ciudad, no por despejados (unos 162 cubiertos); hacia Xivares y Aboño el aire de industria es un matiz real según el viento. Quien firme solo un agosto soleado en el Muro, sin probar un martes de noviembre urbano ni un día hacia el oeste con viento de Aboño, se llevará una ciudad distinta de la postal de playa.",
      ],
      veredicto:

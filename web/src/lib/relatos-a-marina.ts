...
export const RELATOS_A_MARINA: Record<string, RelatoMun> = {
  "o-vicedo": {
    ...
    historia: [
      ...
      "Estaca de Bares, a unos veinte minutos, añade la capa geográfica que pocos municipios pueden rivalizar: faro, cabo, viento y aves migratorias en el techo de la península. Lo que conviene saber aquí es de costa extrema y ría de frontera provincial, no de villa amurallada ni de casas de indianos.",
    ],
    fuera: [
  ...
  viveiro: {
    ...
    casa: [
      ...
      "El precio medio ronda 1.250 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 146.000 euros. La franja media puede ser piso reformado en casco o vivienda con más espacio hacia la orilla: el estado importa más que el metro solo.",
  ...
  xove: {
    ...
    casa: [
      ...
      "El precio medio ronda 950 €/m², de los más bajos de la zona. Tres habitaciones en tipologías modestas quedan en franja muy asequible —alrededor de 111.000 euros en la franja asequible—; el estado de la reforma importa más que una media única.",
  ...
  cervo: {
    ...
    historia: [
      ...
      "San Cibrao aporta puerto, Museo Provincial do Mar y la península habitada frente al Cantábrico: la ficha marinera y la de la costa vivida. Alcoa explica la capa laboral reciente —empleo, población, incertidumbre—. Lo que conviene saber junta cerámica, mar e industria en pocos kilómetros.",
    ],
    fuera: [

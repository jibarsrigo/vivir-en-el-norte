...
export const RELATOS_LITORAL_NORTE: Record<string, RelatoMun> = {
  esposende: {
    ...
    abrir: [
      ...
      "El tráfico es de costa llana casi todo el año. Julio y agosto cambian la música: Ofir y Apúlia reciben el veraneo de Braga y Porto, el aparcamiento se queda corto junto a las pasarelas y la nortada de tarde —viento norte fuerte de junio a agosto— marca terrazas y toallas. Hay obra nueva y fibra. Quien busque silencio absoluto de enero lo encontrará entre pinos; quien busque café en la villa también. Las dos cosas conviven aquí.",
      "La semana tiene anclas: paseo del estuario, supermercado y centro de salud en la villa, pasarelas del parque cuando el cielo limpia. Primavera y otoño merecen su visita: las dunas sin gentío, Fão con ritmo de villa antigua, el Cávado ancho. Quien solo conozca un sábado de sol en Apúlia firmará la postal; quien haya visto un julio con nortada y un martes gris de noviembre firmará —o no— la vida.",
      "El verano, sin embargo, tiene días que desbordan esa calma residencial. Fiestas locales y el veraneo llenan Ofir, Apúlia y el paseo con música, tráfico y afluencia unas semanas. Vivir junto a la playa o al estuario significa contar con noches más ruidosas y coches en las cunetas; hacia Marinhas o las calles interiores de la villa, el volumen baja. Quien firme aquí acepta villa y dunas a cambio del máximo sol de la tabla y Braga y Porto a treinta–cuarenta minutos.",
    ],
    tiempo: [
      "Si vienes de Baleares, el cuerpo tarda en recalibrar el viento más que el frío. Esposende suma unas 2.550 horas de sol y unos 85 días despejados —el máximo de la tabla—, frente a las 2.800 horas y 120 jornadas claras de Mallorca. Caen alrededor de 1.200 a 1.300 milímetros en unos 105 a 108 días: los menos días de lluvia de la comparación, con julio y agosto casi secos —unos dos días al mes—. La diferencia de cielo se come casi toda entre noviembre y abril; de junio a septiembre la terraza se usa, aunque la nortada de tarde pide abrigo o resguardo.",
    ...
    vivir: [
      ...
      "En la villa y en Ofir–Apúlia hay pisos, chalés entre pinos y torres de los setenta; hay obra nueva y fibra. El modelo es vivienda residencial con duna o estuario cerca, no solo bloque de frente. En primera línea pesan nortada, salitre y ocupación de verano. Tres habitaciones suelen pedir cinco–diez minutos hasta la playa; comprobar una tarde de viento antes de firmar.",
    ],
    historia: [
      ...
      "Ofir nació como colonia de veraneo de Braga: torres de los setenta, chalés bajo pinar, la idea de costa residencial sin el paseo de bloques de Póvoa. Apúlia marca la otra postal: molinos de viento sobre las dunas —imagen que resume el Parque Natural do Litoral Norte— y playa abierta al Atlántico. Marinhas y el paseo de la villa completan un relato de costa llana: estuario, dunas protegidas y veraneo entre pinos, no casino ni metro.",
    ],
    fuera: [
      "Si solo hay tiempo para un baño cerca, ese baño puede ser Ofir —arena junto a pinos y urbanización— o Apúlia —playa abierta, molinos detrás—. El agua atlántica anda entre 16 y 18 °C: fresca, a veces con mordisco, nunca tibia como Mallorca. Un martes de junio puedes tener casi toda la arena; un domingo de agosto el aparcamiento junto a las pasarelas se queda corto. Es playa de diario residencial, no de resort de bloques.",
      "El estuario del Cávado cambia el registro: agua más abrigada, paseo de villa, puerto, la sensación de río entregándose al océano. Ahí se baña quien no quiere pelear con la nortada abierta. Las pasarelas del Parque Natural —unos dieciséis kilómetros entre Apúlia y la Foz do Cávado— son la tarde llana sobre dunas: madera, viento, aves, sin pedir un paseo de hormigón.",
  ...
  "povoa-de-varzim": {
    ...
    abrir: [
      ...
      "El tráfico es de ciudad costera casi todo el año. Julio y agosto cambian la música: el veraneante de Porto llena el paseo con ruido, afluencia y aparcamiento difícil; la nortada de tarde —viento norte fuerte— marca terrazas y toallas. Hay obra nueva abundante y fibra. Quien busque silencio absoluto de enero lo encontrará unas calles atrás del frente; quien busque el café abierto también. Las dos cosas conviven aquí, y eso es raro en una ciudad de bloques.",
      "La semana tiene anclas: paseo, mercado, metro, puerto. Primavera y otoño merecen su visita: el Atlántico sin gentío, el casino sin cola de agosto, Porto a media hora sin la A28 saturada. Quien solo conozca un día de sol en Redonda firmará la postal; quien haya visto un agosto lleno y un martes gris de noviembre firmará —o no— la vida.",
    ...
    historia: [
      ...
      "El metro —línea B— marca la conexión: no es villa aislada, es ciudad de playa enganchada a Porto. Estela Golf —links junto al mar a unos diez minutos— completa el relato de costa llana: ocio, viento, arena. La historia útil aquí es de balneario, pesca y ciudad viva todo el año, no de casco conventual ni de dunas protegidas.",
    ],
    fuera: [
      ...
      "El paseo marítimo —uno de los más largos de Portugal— es la tarde de diario: hormigón, viento, mar a un lado, bloques al otro. El puerto pesquero añade olor a lonja y ritmo de trabajo. Estela Golf queda a unos diez minutos: links junto al mar cuando apetezca otro registro.",
  ...
  "vila-do-conde": {
    ...
    abrir: [
      ...
      "El tráfico es de ciudad casi todo el año. Julio y agosto cambian la música: Azurara y el paseo reciben más afluencia, la A28 se congestiona hacia Porto en hora punta y la nortada de tarde marca la terraza. Hay obra nueva y fibra. Quien busque silencio absoluto de enero lo encontrará en calles laterales del casco; quien busque café junto al Ave también. El ritmo de ciudad histórica se mantiene mejor que el de un frente solo de bloques.",
      "La semana tiene anclas: Santa Clara, acueducto, mercado, metro, orilla del Ave. Primavera y otoño merecen su visita: el casco sin gentío de agosto, Mindelo con aves, Azurara con menos tablas. Quien solo conozca Santa Clara un día de sol firmará el monumento; quien haya visto un agosto en Azurara y un martes gris junto al río firmará —o no— la vida.",
    ...
    vivir: [
      "El invierno en Vila do Conde es de ciudad histórica que mantiene ritmo: niebla de mar por la mañana, lluvia y humedad del Ave piden calefacción y aislamiento. En el frente de Azurara pesan salitre y nortada; hacia el casco, calles de piedra más abrigadas. Probar un martes gris junto al río evita firmar solo por Santa Clara en sol.",
    ...
    historia: [
      ...
      "Azurara añade la costa de surf; Mindelo —reserva ornitológica a unos diez minutos— la capa de naturaleza en costa llana. La historia útil no es lista seca de monumentos: es convento, acueducto, nao y astilleros en una ciudad que hoy mira a Porto por carretera y por raíl, con el aeropuerto a un cuarto de hora.",
    ],
    fuera: [
    ...
    casa: [
      "En el casco y el ensanche hay pisos; en el frente, bloques. Hay obra nueva y fibra. El modelo puede ser piso hacia el Ave con acceso al casco, o vivienda en el frente de Azurara con más viento y más agosto. En primera línea pesan ocupación estival, salitre y nortada; conviene comprobar ambos.",
      "El precio medio ronda 2.600 €/m². Dos habitaciones en la franja asequible se sitúan alrededor de 220.000 euros. Tres habitaciones rondan 304.000 euros —fuera de la orilla asequible habitual—. Quien busque tres habitaciones dentro de esa orilla deberá aceptar distancia a la playa o mirar Esposende.",
      "Los servicios son 8/10; comunicaciones, 9/10. El hospital queda a unos diez minutos; CUF Porto, a unos treinta. Porto–Sá Carneiro está a unos quince. Hay que contar con seguro privado portugués. Conviene probar Azurara en temporada y un noviembre en el casco antes de firmar.",
    ],
    encaja: {
      si: [
        "El aeropuerto a un cuarto de hora pesa más que la calma de dunas. Vila do Conde reúne casco histórico —convento de Santa Clara, acueducto de 999 arcos, Alfândega, Nau Quinhentista—, río Ave, playas de Vila do Conde y Azurara —surf—, Mindelo —reserva ornitológica— a unos diez minutos, metro —línea B— y A28. Los servicios alcanzan 8/10; las comunicaciones, 9/10; la dependencia del coche, 3/10. El hospital comarcal queda a unos diez minutos; Porto–Sá Carneiro, a unos quince —el acceso más rápido de toda la tabla junto a Vigo y A Coruña: Palma en verano y más de ochenta destinos—. Quien quiera ciudad monumental con Porto a media hora y el Ave como orilla urbana encontrará aquí el marco: un martes de noviembre se camina el casco; el ritmo no se apaga fuera de temporada.",
        "También encaja para quien priorice historia y conexiones frente a Ofir y Apúlia: se aceptan bloques en el frente y mar abierto a dieciséis–dieciocho grados —frío, con nortada de tarde— a cambio de acueducto, metro y el mejor vuelo de la zona. El precio medio ronda 2.600 €/m²; dos habitaciones en franja asequible, alrededor de 220.000 euros. Obra nueva y fibra. CUF Porto anda alrededor de treinta minutos.",
      ],
      no: [

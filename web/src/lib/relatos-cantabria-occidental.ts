...
export const RELATOS_CANTABRIA_OCCIDENTAL: Record<string, RelatoMun> = {
  "san-vicente-de-la-barquera": {
    ...
    abrir: [
      ...
      "San Vicente encaja para quien quiera esa vista de ría y Picos todos los días y acepte hospital y aeropuerto a cuarenta o cuarenta y cinco minutos. Quien solo conozca un sábado de sol se quedará con la foto bonita; quien haya visto un noviembre gris decidirá —o no— si quiere vivir aquí.",
    ],
    tiempo: [
  ...
  comillas: {
    ...
    abrir: [
      ...
      "Comillas encaja para quien quiera vivir en una villa-museo cara y muy cuidada, aceptando comercio estacional y verano lleno. Quien solo conozca un sábado soleado se quedará con la foto bonita del Capricho; quien haya visto un noviembre quieto decidirá —o no— si quiere vivir aquí.",
    ],
    tiempo: [
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco si se necesita calma en julio y agosto en el casco, o el cielo de Baleares. Quien se decida solo con un sábado soleado de verano, sin probar el aparcamiento de temporada ni un noviembre casi vacío, se llevará una villa distinta de la postal. Si lo que manda es hospital a quince minutos y playa con vida todo el año, Suances; si mandan casas bajas, Valdecilla y aeropuerto a quince, Liencres. Comillas pide aceptar estacionalidad, metro alto y sol bajo a cambio del modernismo.",
      ],
      veredicto:
        "Veredicto: Comillas encaja como villa modernista —dos habitaciones en casco, o tres algo retiradas de la primera línea de temporada— sobre todo si Capricho, Sobrellano y la playa a dos minutos importan más que el comercio de invierno. Probar un agosto lleno y un noviembre quieto antes de firmar. Se ganan museo al aire libre, Sierrallana a treinta y fibra; se aceptan servicios 4/10, precio alto (~2.400 €/m²) y unas 1.700 horas de sol. Quien priorice vida diaria todo el año, Suances; quien priorice logística y dunas, Liencres.",
    },
    fotosAbrir: [
  ...
  suances: {
    ...
    abrir: [
      ...
      "En verano La Concha y Los Locos reciben toallas, tráfico hacia la playa y algo de ruido de temporada; hacia el casco alto el volumen baja antes. Fuera de agosto Suances sigue siendo villa con mesas y comercio abiertos. Primavera y otoño merecen su visita: la ría y el paseo no son solo foto de julio.",
      "El calendario tiene anclas. Las fiestas de la Virgen del Carmen —mitad de julio— animan el puerto y el casco con procesión y ambiente marinero; las patronales de San Leandro completan el verano local. Son jornadas de música, gente y aparcamiento justo; quien viva junto a La Concha o al puerto debe contarlas como parte del año. El resto de la semana, fuera de agosto, vuelve el día a día de villa.",
      "Suances encaja para quien quiera villa con playa, vida todo el año y hospital y aeropuerto a quince o veinte minutos. Quien solo conozca un sábado soleado en La Concha se quedará con la foto bonita de la playa; quien haya visto un martes de noviembre decidirá —o no— si quiere la semana resuelta.",
    ],
    tiempo: [
    ...
    vivir: [
      ...
      "El día a día sin coche es más viable que en Comillas o San Vicente: se camina el casco, se compra en villa y los servicios alcanzan 6/10. Torrelavega a quince minutos cubre lo que falta. Quien elija casco alto ganará vistas y cuestas; junto a La Concha, orilla y más ocupación de verano. En enero hay mesas y comercio abiertos: día a día de villa, no de museo vacío.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco si se necesita calma total en agosto en primera línea de La Concha, o el cielo estable de Mallorca. Quien se decida solo con un sábado soleado sin probar el aparcamiento de temporada ni un noviembre de cielo cubierto se equivoca de opción. Si la prioridad absoluta es ciudad completa a pie —Valdecilla a cinco, aeropuerto a diez—, Santander; si mandan Capricho y museo, Comillas. Suances pide aceptar cubiertos, lluvia de verano y algo de afluencia en la orilla a cambio de la semana resuelta junto al mar.",
      ],
      veredicto:
        "Veredicto: Suances encaja como villa-playa equilibrada —tres habitaciones en casco o cerca del paseo, fuera del tramo más ocupado de La Concha en agosto— sobre todo si hospital a quince, aeropuerto a veinte y vida de villa en noviembre importan más que la postal del oeste. Probar un martes gris y un día de temporada en la playa antes de firmar. Se ganan Concha, Locos, Torrelavega a quince y Seve Ballesteros a veinte; se aceptan ~2.000 €/m², servicios 6/10 y el sol bajo de Cantabria. Quien priorice dunas y seguridad máxima, Liencres; quien priorice ría y Picos, San Vicente.",
    },
    fotosAbrir: [
  ...
  "liencres-pielagos": {
    ...
    abrir: [
      ...
      "Liencres encaja para quien priorice seguridad, hospital y vuelo a Palma con urbanización de casas bajas junto al mar, a cambio del sol de Cantabria. Quien solo conozca un sábado soleado en Canallave se quedará con la foto bonita de la duna; quien haya visto el gris de noviembre decidirá —o no— si acepta el peaje del cielo.",
    ],
    tiempo: [
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco si se necesita calma total en agosto junto a Valdearenas o Canallave: las dunas reciben temporada. Quien se decida solo con un sábado soleado sin probar un noviembre cubierto ni el tráfico hacia la playa se llevará una sorpresa. Si la prioridad absoluta es caminar ciudad completa —servicios 10/10, Valdecilla a cinco—, Santander; si se busca villa-playa con casco alto y vida propia, Suances. Liencres pide aceptar el sol más bajo de la tabla a cambio de la logística más sólida.",
      ],
      veredicto:
  ...
  santander: {
    ...
    abrir: [
      ...
      "Santander encaja para quien prefiera ciudad completa; para quien mire Liencres, es la ciudad de referencia a quince minutos. Quien solo conozca un sábado soleado en el Sardinero se quedará con la foto bonita de la playa; quien haya visto un invierno de cielo cubierto decidirá —o no— si quiere la capital.",
    ],
    tiempo: [
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco si se busca villa marinera pequeña o silencio de noviembre como en Comillas fuera de temporada. Quien se decida solo con por el Sardinero en un sábado de sol, sin probar un invierno de cielo cubierto ni el ritmo de ciudad, puede descubrir que la capital no era lo que pedía el día a día. Si mandan playa de villa con hospital a quince y metro más amable, Suances; si mandan dunas y seguridad máxima, Liencres. Santander pide aceptar precio de capital y sol bajo a cambio de caminar casi toda la semana.",
      ],
      veredicto:

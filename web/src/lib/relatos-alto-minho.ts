...
export const RELATOS_ALTO_MINHO: Record<string, RelatoMun> = {
  valenca: {
    ...
    abrir: [
      ...
      "El verano del valle cambia la música. Media alrededor de 21 °C y unos veinte días por encima de 30 °C: el calor que en Caminha o Âncora casi no aparece. En invierno, niebla media de río que levanta a media mañana. Hay poca obra nueva; fibra sí. El tráfico es de villa casi todo el año; los fines de semana fronterizos llenan el aparcamiento de la fortaleza y las mesas. Quien busque silencio absoluto de enero lo encontrará en las calles laterales; quien busque el café abierto también. Las dos cosas conviven aquí.",
      "El calendario marca agosto con fiestas locales —ruido, afluencia, mesas ocupadas dentro de los muros— y el goteo de quien cruza desde Tui. Primavera y otoño merecen su visita: la Ecopista entre viña, el Miño ancho, Galicia enfrente sin aduana. Quien solo conozca un sábado de sol en la fortaleza firmará la postal; quien haya visto un julio de valle y un martes gris de noviembre firmará —o no— la vida.",
    ...
    vivir: [
      ...
      "Dentro de la fortaleza y en el ensanche hay pisos y viviendas de villa; hay poca obra nueva y fibra. El modelo no es urbanización cerrada: es piso con acceso al puente o casa de villa con el muro cerca. En verano pesan calor de valle y ocupación de fin de semana fronterizo. Comprobar aparcamiento un sábado dentro de los muros antes de firmar.",
    ],
    historia: [
      ...
      "El tren Celta a Vigo y Porto y la Ecopista do Minho hacia Monção completan el relato fluvial: antigua vía convertida en camino llano entre Alvarinho y río. La historia útil no es lista de fechas; es fortaleza, comercio y frontera permeable. Quien camine los baluartes un martes de enero entenderá por qué los gallegos siguen viniendo: no es museo, es villa dentro del muro.",
    ],
    fuera: [
  ...
  "vila-nova-de-cerveira": {
    ...
    abrir: [
      ...
      "En verano la praia fluvial y el puente reciben más afluencia; el ritmo de villa de arte se mantiene mejor que el de Moledo o Âncora en agosto. La Bienal marca el calendario: exposición, visitas, mesas llenas unas semanas. Los sábados, la feria —fruta, ropa, artesanía— atrae también a medio Baixo Miño desde el otro lado. Quien busque silencio absoluto de enero lo encontrará en las calles laterales; quien busque café y río también.",
      "Primavera y otoño merecen su visita: el Alto do Cervo con la vega verde, el paseo fluvial, Goián enfrente sin aduana. Quien solo conozca un fin de semana de Bienal firmará la exposición; quien haya visto un martes gris de río y un sábado de feria firmará —o no— la vida. Hay poca obra nueva; fibra sí.",
    ...
    vivir: [
      ...
      "El casco y el entorno del río ofrecen viviendas de villa; hay poca obra nueva y fibra. El modelo es casa o piso de villa con el Miño cerca, no urbanización cerrada. Junto al río pesan humedad y ocupación de fin de semana. Probar un sábado de feria y un martes vacío antes de firmar.",
    ],
    historia: [
      ...
      "El Alto do Cervo —mirador sobre la vega— y la praia fluvial completan el relato de orilla y monte suave. La historia útil es de villa culta sobre el Miño: no lista seca de monumentos, sino castillo, arte y frontera permeable. Quien cruce el puente un sábado de feria entenderá por qué Goián y Cerveira funcionan como un solo gesto.",
    ],
    fuera: [
  ...
  caminha: {
    ...
    abrir: [
      ...
      "En verano Foz do Minho, el pinar y el ferry reciben más afluencia: ruido, aparcamiento justo, mesas ocupadas. El viento es medio. Hay poca obra nueva; fibra sí. El tráfico de la N-13 se nota en temporada; el resto del año es villa de desembocadura. Quien busque silencio de enero lo encontrará; quien busque terraza abierta también, con el río entregándose al Atlántico delante.",
      "El Camino Portugués de la Costa pasa por la villa: mochilas, sellos, un goteo que no cierra en noviembre. Primavera y otoño merecen su visita: Arga verde, estuario sin saturación, ferry cuando opera. Quien solo conozca un sábado soleado en la Torre do Relógio firmará la postal; quien haya visto viento medio y un día de desembocadura llena firmará —o no— la vida.",
    ...
    vivir: [
      ...
      "El casco y el entorno de la desembocadura ofrecen viviendas de villa; hay poca obra nueva y fibra. El modelo es piso o casa de villa, no urbanización cerrada. Junto a Foz do Minho pesan salitre, viento y ocupación de verano. Orientación y un día de afluencia en la boca del río antes de firmar.",
    ],
    historia: [
      "La Torre do Relógio, la iglesia matriz y la plaza explican Caminha: villa histórica en la boca del Miño, puerta de entrada y de vigilancia cuando el río era frontera de guerra. El Forte da Ínsua —isla fortificada del siglo XVII frente a la desembocadura— marca ese oficio de guardar la boca; hoy es postal y paseo por el pinar cuando la marea y el acceso lo permiten. El ferry a A Guarda convierte Galicia en gesto cotidiano: se mira el otro país y, cuando opera el barco, se corta el estuario en minutos.",
      "La Serra d'Arga detrás completa el relato de río, mar y monte: aldeas de piedra, caballos, rutas desde el concelho. El Camino Portugués de la Costa añade mochilas todo el año. La historia útil es de villa de desembocadura: torre, fuerte, plaza y frontera permeable, no lista seca de fechas.",
    ],
    fuera: [
    ...
    casa: [
      "El casco y el entorno de la desembocadura ofrecen viviendas de villa; hay poca obra nueva y fibra. El modelo es piso o casa de villa, no urbanización cerrada. Junto a Foz do Minho pesan salitre, viento y ocupación de verano; conviene la orientación y probar un día de afluencia en la boca del río.",
      "El precio medio ronda 1.900 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 222.000 euros. Quien busque primera línea de estuario pagará el paisaje; quien se retire unas calles ganará calma de noviembre.",
      "Los servicios son 5/10. Santa Luzia —Viana— queda a unos treinta minutos. Porto–Sá Carneiro está a unos sesenta. Hay que contar con seguro privado portugués —Trofa Saúde, Braga, alrededor de sesenta minutos—. Conviene probar un martes de plaza y un día de desembocadura llena antes de firmar.",
    ],
    encaja: {
      si: [
        "Encaja si se quiere villa histórica en la boca del Miño con Galicia enfrente todo el año, no solo en agosto. La plaza —Torre do Relógio, iglesia matriz—, el pinar hacia el Forte da Ínsua y el ferry estacional a A Guarda convierten la frontera en gesto cotidiano: se mira el otro país y, cuando opera el barco, se corta el estuario en minutos. Foz do Minho y Moledo quedan a unos cinco minutos; la Serra d'Arga cierra el horizonte por detrás. Un martes de noviembre se camina la plaza sin depender del veraneo. Quien priorice desembocadura, Camino Portugués de la Costa y sol de costa —unas 2.500 horas, de las mejores de la tabla— frente a ciudad completa encontrará aquí una villa reconocible a unos 1.900 €/m².",
      ...
      no: [
        ...
        "Tampoco encaja si se busca el régimen fiscal especial para residentes extranjeros —cerrado en 2024— o un aeropuerto a menos de una hora: Porto queda a unos sesenta minutos. Quien firme solo un sábado soleado en la plaza, sin probar viento medio ni un día de desembocadura llena, se llevará una villa distinta.",
      ],
      veredicto:
        "Veredicto: Caminha es villa de desembocadura —plaza histórica, Ínsua y ferry a A Guarda a cambio de servicios medios y mar frío—. Buscaría tres habitaciones hacia el casco o Foz do Minho, fuera del tramo más ocupado en agosto, tras probar un martes de noviembre y un día de afluencia en la boca del río. Se ganan Galicia enfrente, playas a cinco minutos y ~1.900 €/m²; se aceptan servicios 5/10, agua a 16–18 °C, hospital a unos treinta minutos y seguro privado portugués. Si mandan playa abrigada y mercado a pie, Âncora; si pesan aldea de granito y Viana a quince, Afife-Carreço; si la postal es río y torre frente a Portugal, Caminha justifica la escala.",
    },
    fotosAbrir: [
  ...
  "moledo-caminha": {
    ...
    abrir: [
      ...
      "En verano la nortada de tarde —junio a agosto— marca las terrazas: viento norte fuerte que apaga la conversación al aire libre y llena la orilla de velas y tablas. Kite y surf no son postal; son oficio de la tarde. Sin obra nueva; fibra sí. El tráfico de acceso se nota en agosto; el resto del año es colonia entre pinos. Quien busque silencio de enero lo encontrará; quien busque terraza sin viento en julio, no.",
      "Primavera y otoño merecen su visita: dunas sin saturación, pinar, Ínsua enfrente. Quien solo conozca un sábado de sol entre pinos firmará la postal; quien haya visto un julio con nortada y un martes vacío de noviembre firmará —o no— la vida. Moledo es la orilla más escénica de la zona y también la más cara.",
    ...
    vivir: [
      ...
      "Predominan chalés entre pinos; no hay obra nueva y hay fibra. El modelo es casa de colonia, no piso de villa compacta. En primera línea pesan nortada, salitre y precio —el más caro de la zona—. Tres habitaciones suelen quedar fuera de la orilla asequible; conviene retirarse del frente más ventoso y probar una tarde de julio con viento.",
    ],
    historia: [
      "Los chalés entre pinos y el veraneo de Porto explican Moledo: colonia elegante de costa, no casco medieval. Aquí la historia útil es de ocio burgués plantado sobre dunas, de casas que miran el Atlántico y de un oficio de playa —kite, surf— que llegó después y se quedó. El Forte da Ínsua —isla fortificada en la desembocadura— y Santa Trega enfrente marcan la postal de boca del Miño: Portugal y Galicia en el mismo horizonte.",
    ...
    fuera: [
      "La playa de Moledo —arenal largo, dunas, oleaje, nortada de tarde en verano— es la tarde de diario, a dos minutos. El pinar abriga los chalés; las dunas abrigan la mirada. El Forte da Ínsua queda enfrente, en la boca del río: fuerte del siglo XVII sobre islote, postal de desembocadura.",
    ...
    casa: [
      "Predominan chalés entre pinos; no hay obra nueva y hay fibra. El modelo es casa de colonia, no piso de villa compacta. En primera línea pesan nortada, salitre y precio —el más caro de la zona—. Conviene retirarse del frente más ventoso y probar una tarde de julio con viento.",
      "El precio medio ronda 2.300 €/m². Tres habitaciones se sitúan alrededor de 269.000 euros —fuera de la orilla asequible habitual de la zona—. Dos habitaciones en la franja asequible rondan unos 194.000 euros. Quien necesite tres habitaciones baratas junto al mar deberá mirar otra casilla.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco encaja si se buscan servicios a pie, obra nueva o el régimen fiscal especial para residentes extranjeros —cerrado en 2024—. Quien firme solo un sábado de sol entre pinos, sin probar un julio con nortada ni un martes vacío de noviembre, se llevará una colonia distinta de la postal.",
      ],
      veredicto:
        "Veredicto: Moledo es pinar y playa elegante —dunas e Ínsua a cambio de viento, precio alto y servicios mínimos—. Buscaría dos habitaciones o chalé retirado de la primera línea más ventosa, tras probar nortada de tarde y un noviembre entre pinos. Se ganan Atlántico a dos minutos y el cielo más limpio de la zona; se aceptan ~2.300 €/m², servicios 3/10, mar a 16–18 °C, aeropuerto a unos sesenta minutos y seguro privado portugués. Si mandan villa con mercado y espigón abrigado, Âncora; si pesan granito, monte y Viana a quince, Afife-Carreço; si la prioridad es la orilla más escénica y se acepta el viento, Moledo.",
    },
    fotosAbrir: [
  ...
  "vila-praia-de-ancora": {
    ...
    abrir: [
      "Vila Praia de Âncora se siente más villa que postal de verano. Unos cinco mil habitantes: puerto pesquero, fortaleza de Lagarteira —baluarte del siglo XVII junto a la orilla—, playa con tramo abrigado por el espigón —la mejor para bañarse con calma de la zona—, Gelfa —pinar y dunas hacia el sur—, mercado, tren —Viana en unos veinte minutos, Porto en hora y media— y Serra d'Arga por el valle del Âncora. Aquí el mar no es solo horizonte: es lonja, paseo y baño usable.",
      ...
      "En verano Porto y Braga llenan la orilla: ruido, tráfico, afluencia unas semanas. El viento es medio —menos duro que en Moledo—. Hay poca obra nueva; fibra sí. El ritmo de villa se mantiene todo el año; agosto lo desborda, no lo inventa. Quien busque silencio absoluto de agosto junto al espigón se llevará una sorpresa; quien busque café de enero, no.",
      "El calendario marca el veraneo de interior portugués y el Camino de costa. Primavera y otoño merecen su visita: Gelfa sin saturación, Arga por el valle, tren a Viana. Quien solo conozca un día de espigón en calma firmará la playa; quien haya visto agosto y un martes gris firmará —o no— la vida.",
    ...
    vivir: [
      ...
      "Sin coche, farmacia, súper y café se resuelven en el casco —servicios 6/10, fibra—; para el hospital hace falta vehículo. En enero hay mesas y mercado sin depender de la temporada. Quien viva junto al espigón notará más agosto; hacia el casco, ritmo de villa marinera todo el año. El tren a Viana en unos veinte minutos ayuda.",
      "Conviven gente local, familias y veraneantes de Porto y Braga que vuelven en agosto. El portugués manda; el Camino de costa aporta goteo de peregrinos. En verano Porto y Braga llenan la orilla: ruido, tráfico, afluencia unas semanas. La integración pasa por lonja, mercado y villa abierta en enero, no por colonia de pinos.",
      ...
      "El casco y el entorno del puerto ofrecen viviendas de villa; hay poca obra nueva y fibra. El modelo es piso o casa de villa, no chalé de colonia abierta. En primera línea pesan ocupación de agosto y salitre. Imaginar agosto lleno y enero de mercado antes de firmar.",
    ],
    historia: [
      ...
      "Gelfa —pinar y dunas al sur— y el valle del Âncora hacia la Serra d'Arga completan el relato de orilla y monte. El Camino Portugués de la Costa pasa cerca. La historia útil es de villa abrigada: puerto, fuerte, mercado y espigón, no lista seca de monumentos.",
    ],
    fuera: [
    ...
    casa: [
      "El casco y el entorno del puerto ofrecen viviendas de villa; hay poca obra nueva y fibra. El modelo es piso o casa de villa, no chalé de colonia abierta. En primera línea pesan ocupación de agosto y salitre; conviene algo retirado del frente más lleno y probar un día de afluencia.",
      "El precio medio ronda 2.000 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 234.000 euros. Quien busque equilibrio de costa —servicios y playa— encontrará aquí más coherencia que en Moledo; quien busque precio de interior, no.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco encaja si se busca el régimen fiscal especial para residentes extranjeros —cerrado en 2024— o aeropuerto a menos de una hora: Porto queda a unos sesenta minutos. Quien firme solo un día de espigón en calma, sin probar agosto ni un martes gris, se llevará una villa distinta.",
      ],
      veredicto:
        "Veredicto: Vila Praia de Âncora es la villa marinera abrigada del Alto Minho —puerto, mercado y espigón a cambio de veraneo de agosto y mar frío—. Buscaría tres habitaciones hacia el casco o algo retiradas del frente más ocupado, tras probar un martes de noviembre y un día de afluencia en la orilla. Se ganan playa abrigada, servicios 6/10, tren y hospital a unos veinte minutos; se aceptan ~2.000 €/m², agua a 16–18 °C y seguro privado portugués. Si mandan granito, monte y silencio de aldea, Afife-Carreço; si pesan ciudad completa, Viana; si la prioridad es vivir junto al mar con recados a pie, Âncora es la opción más coherente de la costa.",
    },
    fotosAbrir: [
  ...
  "afife-carreco": {
    ...
    abrir: [
      "Afife —unos mil quinientos habitantes— y Carreço —unos mil ochocientos—, con Areosa a continuación, se sienten como la casilla donde el Alto Minho más se parece a vivir en granito con océano cerca. Son las freguesias del norte de Viana: aldeas de piedra entre la Serra d'Arga —825 m, caballos, aldeas de monte— y el mar, viñas en pérgola, huertas, molinos y faro de Montedor en Carreço, playas de Afife —surf, orilla abierta— y Paçô a unos tres minutos, apeaderos de tren hacia Viana.",
      ...
      "Primavera y otoño merecen su visita: Arga verde, Paçô sin saturación, faro de Montedor con la costa abierta. Quien solo conozca un día de sol en la playa firmará el océano; quien haya visto nortada en la orilla y un noviembre vacío en la aldea firmará —o no— la vida. Es la elección del estudio en Portugal para quien quiera monte detrás y mar cerca con ciudad completa a quince minutos.",
    ...
    vivir: [
      ...
      "Predominan casas de granito con terreno; hay poca obra nueva y fibra parcial —hay que comprobarla parcela a parcela—. El modelo es rehabilitación de piedra o casa baja en aldea, no piso de ensanche. Imaginar escaleras de piedra, humedad de monte y acceso a Paçô un día de nortada antes de firmar.",
    ],
    historia: [
      ...
      "Areosa a continuación y los apeaderos de tren completan el relato de aldea y conexión con Viana: se baja al andén y la ciudad del Lima queda a un gesto corto. La historia útil es de piedra, monte y mar a tres minutos —la escala que el estudio compara con vivir en granito con océano cerca—, no lista de monumentos urbanos.",
    ],
    fuera: [
    ...
    casa: [
      "Predominan casas de granito con terreno; hay poca obra nueva y fibra parcial —hay que comprobarla parcela a parcela—. El modelo es rehabilitación de piedra o casa baja en aldea, no piso de ensanche. Junto a la playa pesan nortada y salitre; en la aldea, humedad de monte. Conviene orientar y probar noviembre.",
      "El precio medio ronda 2.100 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 246.000 euros; casa de granito rehabilitada con terreno, 200.000–280.000. Quien busque metros y piedra encontrará más verdad aquí que en un bloque de Viana; quien busque precio de Valença, no.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco encaja si se busca el régimen fiscal especial para residentes extranjeros —cerrado en 2024— o tres habitaciones muy por debajo de la franja asequible —alrededor de 246.000 euros; casa de granito con terreno suele moverse entre 200.000 y 280.000—. Quien firme solo un día de sol en Paçô, sin probar nortada en la playa ni un noviembre vacío en la aldea, se llevará otra vida.",
      ],
      veredicto:
        "Veredicto: Afife-Carreço es aldea de granito entre monte y mar —Arga detrás, Paçô a tres y Viana a quince a cambio de coche y servicios mínimos—. Buscaría casa de granito con terreno en Afife, Carreço o Areosa, con fibra comprobada y acceso claro a la playa, tras probar un martes de noviembre y un julio con nortada en la orilla. Se ganan ~2.100 €/m² de costa, hospital a unos quince minutos y aeropuerto a unos cincuenta y cinco; se aceptan servicios 3/10, mar a 16–18 °C y seguro privado portugués. Si mandan villa con mercado y espigón, Âncora; si pesan ciudad 9/10, Viana; si la prioridad es granito, monte y mar en el mismo gesto, esta es la elección del estudio en Portugal.",
    },
    fotosAbrir: [
  ...
  "viana-do-castelo": {
    ...
    abrir: [
      ...
      "En verano Praia Norte y Cabedelo reciben más afluencia; el ritmo de ciudad se mantiene todo el año —no se apaga en enero—. Hay obra nueva. Facilidad de venta y revalorización altas —8/10—. Quien firme el centro acepta bloques; en las freguesias hay casas bajas. El tráfico es de ciudad pequeña; la N-13 y el frente de playa se notan en agosto.",
      "El calendario marca cultura, mercado y nortada costera de tarde. Primavera y otoño merecen su visita: Santa Luzia sin cola, paseo del Lima, Gil Eannes. Quien solo conozca la vista desde la basílica firmará la postal; quien haya visto un martes laborable y una tarde de nortada en Praia Norte firmará —o no— la vida.",
    ...
    vivir: [
      "El invierno en Viana es de ciudad que no se apaga: el casco mantiene ritmo; la humedad atlántica y la lluvia piden calefacción y aislamiento en pisos de bloque. En Praia Norte pesan salitre y nortada residual. Probar un noviembre de ciudad evita firmar solo por la vista desde Santa Luzia.",
    ...
    historia: [
      ...
      "El buque-hospital Gil Eannes —ahora museo flotante— añade memoria marítima: un barco que fue hospital de la flota bacaladera y hoy se visita amarrado. El paseo del Lima, Praia Norte y Cabedelo completan el arco de río y océano. La historia útil es de ciudad culta, puerto y mirador: Santa Luzia, Eiffel, Gil Eannes, no lista seca de fechas.",
    ],
    fuera: [
    ...
    casa: [
      "En el centro predominan pisos en bloques; en las freguesias, casas bajas. Hay obra nueva y fibra. El modelo urbano pide ascensor y calle; el de freguesía, más terreno y coche. En primera línea de Praia Norte pesan ocupación de verano, salitre y nortada; conviene orientación y probar una tarde de viento.",
      "El precio medio ronda 2.100 €/m². Tres habitaciones en la franja asequible se sitúan alrededor de 246.000 euros. Quien busque casas bajas deberá mirar freguesías o Afife-Carreço; quien busque hospital a cinco y comercio denso, el ensanche o un buen piso de ciudad.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco encaja si se busca el régimen fiscal especial para residentes extranjeros —cerrado en 2024— o hospital privado a menos de cuarenta minutos. Quien firme solo la vista desde Santa Luzia, sin probar un martes de noviembre ni una tarde de nortada en Praia Norte, se llevará una ciudad distinta de la postal.",
      ],
      veredicto:
        "Veredicto: Viana do Castelo es la ciudad del Lima —9/10, hospital a cinco y Atlántico urbano a cambio de bloques en el centro y mar frío—. Buscaría tres habitaciones en freguesía o piso en ensanche con acceso al paseo, tras probar un martes laborable y un agosto en Praia Norte. Se ganan ciudad completa, Santa Luzia y ~2.100 €/m²; se aceptan agua a 16–18 °C, nortada costera y seguro privado portugués. Si mandan granito y monte, Afife-Carreço; si villa marinera abrigada, Âncora; si la prioridad es resolver la semana sin coche y con hospital delante, Viana no tiene rival en la zona.",
    },
    fotosAbrir: [
  ...
  "ponte-de-lima": {
    ...
    abrir: [
      ...
      "Primavera merece el Festival de Jardines; otoño, la Ecovia y las Lagoas sin calor. Quien solo conozca un día de puente en sol firmará la postal; quien haya visto julio de valle y un martes de niebla firmará —o no— la vida. Fibra sí; poca obra nueva en el casco.",
    ...
    vivir: [
      ...
      "Sin coche, la villa compacta se resuelve a pie —servicios 6/10—; para el mar y Braga hace falta vehículo. Un martes de noviembre se camina el puente y la plaza. Las Feiras Novas de septiembre llenan la villa: ruido, afluencia, aparcamiento justo. En enero hay ritmo de villa de piedra, no de costa vacía.",
      "Quien vive aquí es gente local y familias del valle. El portugués manda; la escala es de villa interior minhota —feria, jardines, Loureiro—, no de frontera con gallego a la puerta como Valença. La integración pasa por plaza, Ecovia y calendario de feria. Quien solo conozca el Festival de Jardines firmará la postal; quien haya visto julio de valle firmará —o no— la vida.",
      ...
      "El casco y el entorno del río ofrecen viviendas de villa; hay fibra. El modelo es piso o casa de villa, y quintas con viñedo de Loureiro cuando el terreno pesa. En el valle pesan calor de julio–agosto, niebla de invierno y humedad. Imaginar ambas estaciones y las Feiras Novas antes de firmar.",
    ],
    historia: [
      "El puente romano-medieval y la plaza de la feria explican Ponte de Lima: la villa más antigua de Portugal —fuero en el siglo XII—, capa romana sobre el Lima y feria viva. La leyenda del río del olvido —soldados que no querían cruzar— sigue en el relato local; la piedra del puente sigue en el gesto diario. Las Feiras Novas de septiembre y el Festival de Jardines marcan el calendario con afluencia real: no son notas al margen.",
      "La Ecovia do Lima, las Lagoas de Bertiandos —paisaje protegido de humedal— y el viñedo de Loureiro completan el relato de río y verde. Axis Golfe queda en el concelho; el Gerês, a hora y cuarto. La historia útil es de villa romana, feria y valle del Lima: puente, plaza y agua, no lista seca de fechas.",
    ],
    fuera: [
    ...
    casa: [
      "El casco y el entorno del río ofrecen viviendas de villa; hay fibra. El modelo es piso o casa de villa, y quintas con viñedo de Loureiro cuando el terreno pesa: desde unos 200.000–300.000 euros. En el valle pesan calor de julio–agosto, niebla de invierno y humedad; conviene orientación y probar ambas estaciones.",
      "El precio medio ronda 1.500 €/m². Tres habitaciones se sitúan alrededor de 142.000 euros. Quien busque precio de interior y piedra encontrará holgura frente a Moledo o Âncora; quien busque primera línea de Atlántico, no.",
    ...
    encaja: {
      ...
      no: [
        ...
        "Tampoco encaja si se busca el régimen fiscal especial para residentes extranjeros —cerrado en 2024— o un diciembre sin niebla de valle. Quien firme solo un día de jardines en primavera, sin probar julio caluroso ni un martes de niebla, se llevará una villa distinta de la postal del puente.",
      ],
      veredicto:
        "Veredicto: Ponte de Lima es villa romana de interior —puente, feria y hospital a cinco a cambio de calor de valle, niebla y mar a veinticinco minutos—. Buscaría tres habitaciones en villa o quinta con acceso al puente, tras probar un julio de valle y un diciembre de niebla. Se ganan ~1.500 €/m², Ecovia, Loureiro y el comarcal delante; se aceptan 20–25 días de calor fuerte, aeropuerto a unos cincuenta y cinco minutos y seguro privado portugués. Si mandan verano fresco y Atlántico a pie, Âncora o Afife-Carreço; si pesan piedra, río y precio de interior con sanidad cerca, Ponte de Lima es la apuesta del valle del Lima.",
    },
    fotosAbrir: [
